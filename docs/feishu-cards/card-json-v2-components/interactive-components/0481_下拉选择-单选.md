...
> Source: https://open.feishu.cn/document/feishu-cards/card-json-v2-components/interactive-components/single-select-dropdown-menu
...
disabled | 否 | Boolean | false | 是否禁用该单选组件。该属性仅支持飞书 V7.4 及以上版本的客户端。可选值：<br>- true：禁用单选组件组件<br>- false：单选组件组件保持可用状态
