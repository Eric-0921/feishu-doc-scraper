...
placeholder | 否 | Struct | 选择器的提示文案，无初始值时必填。只能设置[文本组件](https://open.feishu.cn/document/ukTMukTMukTM/uUzNwUjL1cDM14SN3ATN)中的 `"tag": "plain_text"` 模式以及 `content` 参数。<br>示例值:<br>```<br>"placeholder": {<br>"tag": "plain_text",<br>"content": "请选择日期"<br>},<br>```
