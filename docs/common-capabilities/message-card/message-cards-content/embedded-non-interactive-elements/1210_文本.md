...
参数 | 是否必须 | 类型 | 说明
---|---|---|---
tag | 是 | String | 文本元素的标签。两种模式的固定取值：<br>- plain_text：普通文本内容。<br>- lark_md：支持部分 Markdown 语法的文本内容。关于 Markdown 语法的详细介绍，可参见 [Markdown](https://open.feishu.cn/document/ukTMukTMukTM/uADOwUjLwgDM14CM4ATN#abc9b025)。
