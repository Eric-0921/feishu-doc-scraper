...
> Source: https://open.feishu.cn/document/payroll-v1/payment_activity/archive
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 封存发薪活动(payroll:payment_activity:archive)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
activity_id | string | 是 | 发薪活动ID，可通过[查询发薪活动列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/payroll-v1/payment_activity/list)获取。<br>**示例值**："7433255159377444875"
