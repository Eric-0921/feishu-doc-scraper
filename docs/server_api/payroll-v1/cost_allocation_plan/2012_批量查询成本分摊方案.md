...
> Source: https://open.feishu.cn/document/payroll-v1/cost_allocation_plan/list
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取成本分摊方案(payroll:cost_allocation_plan:read)
