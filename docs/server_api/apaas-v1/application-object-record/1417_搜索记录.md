...
order_type | string | 否 | 排序方式<br>**示例值**："asc"<br>**可选值有**：<br>- asc：升序<br>- desc：降序<br>**数据校验规则**：<br>- 长度范围：`0` ～ `256` 字符
...
metadata | string | 否 | 返回元数据枚举值<br>**示例值**："Label"<br>**可选值有**：<br>- Label：只返回 Label<br>- SearchLayout：返回搜索布局信息
