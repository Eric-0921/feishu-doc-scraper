...
> Source: https://open.feishu.cn/document/apaas-v1/application-object-record/query
...
名称 | 类型 | 必填 | 描述
---|---|---|---
select | string\[\] | 否 | 需要获取的字段，使用字段唯一标识符进行查询，关联字段可使用 . 进行下钻<br>**示例值**：["_id"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `256`
