...
> Source: https://open.feishu.cn/document/apaas-v1/application-object-record/batch_create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
records | string | 是 | 记录详情列表，格式为 List<Map<string, ANY>>，操作记录数上限为 500 条<br>**示例值**："[{\"book_name\":\"name21\",\"book_count\":2}]"
