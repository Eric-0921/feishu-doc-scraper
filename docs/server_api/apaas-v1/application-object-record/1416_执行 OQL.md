...
> Source: https://open.feishu.cn/document/apaas-v1/application-object-record/oql_query
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查看对象记录数据(app_engine:object.record:read)<br>创建、更新、删除对象记录数据(app_engine:object.record:write)
