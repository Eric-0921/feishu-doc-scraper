...
> Source: https://open.feishu.cn/document/apaas-v1/application-object-record/batch_delete
...
名称 | 类型 | 必填 | 描述
---|---|---|---
ids | string\[\] | 是 | 记录 ID 列表，操作记录数上限为 500<br>**示例值**：["1801464965461024"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `500`
