...
> Source: https://open.feishu.cn/document/apaas-v1/application-environment_variable/get
...
environment_variable_api_name | string | 环境变量 API 名称<br>**示例值**："globalParam_0b410b17704"
