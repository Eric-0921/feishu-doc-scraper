...
> Source: https://open.feishu.cn/document/apaas-v1/application-audit_log/data_change_log_detail
...
名称 | 类型 | 必填 | 描述
---|---|---|---
log_id | string | 是 | 数据变更日志ID信息<br>**示例值**：7405456257290600492<br>**数据校验规则**：<br>- 长度范围：`0` ～ `1000` 字符
