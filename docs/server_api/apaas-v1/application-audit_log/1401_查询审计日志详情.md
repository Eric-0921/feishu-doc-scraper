...
名称 | 类型 | 必填 | 描述
---|---|---|---
log_id | string | 是 | 审计日志ID信息（通过[查询审计日志列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/apaas-v1/application-audit_log/audit_log_list)获取单条日志ID）<br>**示例值**：7405456257290600492<br>**数据校验规则**：<br>- 长度范围：`0` ～ `1000` 字符
