...
> Source: https://open.feishu.cn/document/moments-v1/post/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查询公司圈内容、板块(moments:moments:readonly)<br>允许管理租户公司圈全部数据(moments:moments:access_all)
...
id | string | 帖子ID
create_time | string | 帖子创建时间，格式 rfc3339，<br>e.g. "2006-01-02T15:04:05Z07:00"
