...
> Source: https://open.feishu.cn/document/moments-v1/post_statistics/events/updated
...
基本 | &nbsp;
---|---
事件类型 | moments.post_statistics.updated_v1
...
event | \- | \-
post_id | string | 帖子ID
statistics_type | int | 变更的统计数据类型（对应 statistics 内字段）<br>**可选值有**：<br>- 1：分享次数
statistics | post_statistics | 帖子统计数据
