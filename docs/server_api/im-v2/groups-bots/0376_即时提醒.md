...
> Source: https://open.feishu.cn/document/im-v2/groups-bots/patch
...
名称 | 类型 | 描述
---|---|---
feed_card_id | string | 消息卡片 id，当前只支持群聊类型<br>**示例值**："oc_679eaeb583654bff73fefcc6e6371370"
...
user_ids | string\[\] | 是 | 用户 ID 列表（ID 类型与 user_id_type 的取值一致。如果是商店应用，因不支持获取用户 user ID 权限，所以无法使用 user_id 类型的用户 ID）<br>**示例值**：["ou_9d2beb613c85a2412862a49a924558c5"]
