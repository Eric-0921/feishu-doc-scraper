...
> Source: https://open.feishu.cn/document/acs-v1/rule_external/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查看智能门禁设备列表(acs:devices:readonly)<br>查看、更新智能门禁用户(acs:users)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
device_id | string | 否 | 设备id<br>**示例值**：7296700518380863767
...
user_type | int | 用户类型<br>**可选值有**：<br>- 1：员工<br>- 2：部门<br>- 10：全体员工<br>- 11：访客
user_id | string | 用户id
