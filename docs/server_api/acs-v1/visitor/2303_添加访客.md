...
> Source: https://open.feishu.cn/document/acs-v1/visitor/create
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看、更新智能门禁用户(acs:users)
...
user_type | int | 是 | 用户类型<br>**示例值**：11<br>**可选值有**：<br>- 1：员工<br>- 2：部门<br>- 10：全体员工<br>- 11：访客
