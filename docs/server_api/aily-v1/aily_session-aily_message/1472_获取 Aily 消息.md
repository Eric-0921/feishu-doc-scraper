...
> Source: https://open.feishu.cn/document/aily-v1/aily_session-aily_message/get
...
aily_message_id | string | 消息 ID<br>**示例值**："message_4df45f2xknvcc"<br>**数据校验规则**：<br>- 长度范围：`0` ～ `32` 字符<br>- 正则校验：`message_[0-9a-hjkmnp-z]{1,24}`
