...
> Source: https://open.feishu.cn/document/ai/document_ai-v1/bank_card/recognize
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 识别银行卡(document_ai:bank_card:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 是 | 识别的银行卡源文件<br>**示例值**：file binary
...
type | string | 识别的字段种类<br>**可选值有**：<br>- card_number：银行卡卡号<br>- date_of_expiry：有效日期
