...
> Source: https://open.feishu.cn/document/ai/document_ai-v1/tw_mainland_travel_permit/recognize
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 识别台湾往来大陆许可证(document_ai:tw_mainland_travel_permit:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 否 | 识别的台湾居民来往大陆通行证源文件<br>**示例值**：file binary
