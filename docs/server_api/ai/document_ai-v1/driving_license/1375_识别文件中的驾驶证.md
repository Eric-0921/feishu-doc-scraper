...
> Source: https://open.feishu.cn/document/ai/document_ai-v1/driving_license/recognize
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 驾驶证识别(document_ai:driving_license:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 是 | 识别的驾驶证源文件<br>**示例值**：file binary
...
type | string | 识别的字段种类<br>**可选值有**：<br>- id_number：证号<br>- name：姓名<br>- sex：性别<br>- nationality：国籍<br>- address：住址<br>- date_of_birth：出生日期<br>- date_of_first_issue：初次领证日期<br>- class：准驾车型<br>- valid_begin：有效期起<br>- valid_end：有效期止<br>- license_issuing_authority：发证机关<br>- document_id：档案编号<br>- record：记录<br>- id_photo_location：相片位置
