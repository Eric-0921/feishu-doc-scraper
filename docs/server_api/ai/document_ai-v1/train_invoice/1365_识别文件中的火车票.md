...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 火车票识别(document_ai:train_invoice:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 是 | 识别的火车票源文件<br>**示例值**：file binary
...
msg | string | 错误描述
data | \- | \-
train_invoices | train_invoice\[\] | 火车票信息
entities | train_entity\[\] | 识别出的实体列表
type | string | 识别的字段种类<br>**可选值有**：<br>- start_station：出发站<br>- end_station：到达站<br>- train_num：车次编号<br>- name：火车票姓名<br>- seat_num：座位号<br>- ticket_num：车票编号<br>- total_amount：价格<br>- time：出发时间<br>- price：金额<br>- seat_num：座位号<br>- seat_cls：座位类型<br>- id_num：身份证号<br>- sale_num：售卖号<br>- sale_station：售卖车站
