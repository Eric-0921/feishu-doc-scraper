...
> Source: https://open.feishu.cn/document/ai/document_ai-v1/hkm_mainland_travel_permit/recognize
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 识别港澳来往内地通行证(document_ai:hkm_mainland_travel_permit:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 是 | 识别的港澳居民来往内地通行证源文件<br>**示例值**：file binary
...
type | string | 识别的字段种类<br>**可选值有**：<br>- full_name_cn：中文姓名<br>- full_name_en：英文格式姓名<br>- date_of_birth：出生日期<br>- date_of_expiry：有效期至<br>- card_number：证件号码
