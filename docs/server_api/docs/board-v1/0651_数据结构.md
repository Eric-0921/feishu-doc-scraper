...
under_line | bool | 是否存在下划线<br>- true：文本内容存在下划线<br>- false：文本内容不存在下划线 | optional，默认 false
...
名称 | 数据类型 | 描述 | 属性
---|---|---|---
type | string | 画笔类型<br>- highlight：高亮笔<br>- marker：马克笔 | optional，默认 highlgiht
