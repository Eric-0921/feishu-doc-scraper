...
> Source: https://open.feishu.cn/document/task-v2/task/remove_members
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 要移除成员的任务全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
...
名称 | 类型 | 必填 | 描述
---|---|---|---
members | member\[\] | 是 | 要移除的member列表<br>**数据校验规则**：<br>- 长度范围：`1` ～ `500`
...
role | string | 是 | 成员角色，支持"assignee"或者"follower"<br>**示例值**："assignee"<br>**数据校验规则**：<br>- 最大长度：`20` 字符
