...
> Source: https://open.feishu.cn/document/task-v2/task/remove_dependencies
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 要移除依赖的任务GUID<br>**示例值**："93b7bd05-35e6-4371-b3c9-6b7cbd7100c0"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
dependencies | task_dependency\[\] | 是 | 要移除的依赖<br>**数据校验规则**：<br>- 长度范围：`1` ～ `50`
