...
> Source: https://open.feishu.cn/document/task-v2/task/add_tasklist
...
如果任务已经在该清单，接口将返回成功。
**注意事项**：需要调用身份同时拥有任务的编辑权限和清单的编辑权限。详情见[任务功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节和[清单功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 要添加到清单的任务的全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"
...
名称 | 类型 | 必填 | 描述
---|---|---|---
tasklist_guid | string | 是 | 要添加到的清单的全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
section_guid | string | 否 | 要添加到清单的自定义分组全局唯一ID，如不填写表示添加到默认分组<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"
...
403 | 1470403 | 缺少将任务加入清单的权限。 | 检查调用身份是否同时拥有任务和清单的编辑权限。详情见[任务功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/overview)中的“任务是如何鉴权的？”章节和[清单功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/overview)中的“清单是如何鉴权的？“章节。
