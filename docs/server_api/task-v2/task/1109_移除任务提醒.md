...
> Source: https://open.feishu.cn/document/task-v2/task/remove_reminders
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 要移除提醒的任务全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
...
名称 | 类型 | 必填 | 描述
---|---|---|---
reminder_ids | string\[\] | 是 | 要移除的reminder的id列表<br>**示例值**：["7202449098622894100"]
