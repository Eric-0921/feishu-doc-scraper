...
> Source: https://open.feishu.cn/document/task-v2/task/add_dependencies
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 任务GUID<br>**示例值**："93b7bd05-35e6-4371-b3c9-6b7cbd7100c0"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
dependencies | task_dependency\[\] | 否 | 要添加的依赖<br>**数据校验规则**：<br>- 长度范围：`1` ～ `50`
type | string | 是 | 依赖类型<br>**示例值**："next"<br>**可选值有**：<br>- prev：前置依赖<br>- next：后置依赖
task_guid | string | 是 | 依赖任务的GUID<br>**示例值**："93b7bd05-35e6-4371-b3c9-6b7cbd7100c0"
