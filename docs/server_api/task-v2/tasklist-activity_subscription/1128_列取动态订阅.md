...
> Source: https://open.feishu.cn/document/task-v2/tasklist-activity_subscription/list
...
名称 | 类型 | 描述
---|---|---
tasklist_guid | string | 清单GUID。可以通过[创建清单](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/create)，或者通过[获取清单列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist/list)接口查询得到。<br>**示例值**："d19e3a2a-edc0-4e4e-b7cc-950e162b53ae"

### 查询参数

名称 | 类型 | 必填 | 描述
---|---|---|---
limit | int | 否 | 返回结果的最大数量<br>**示例值**：50<br>**默认值**：`50`<br>**数据校验规则**：<br>- 取值范围：`1` ～ `50`
