...
> Source: https://open.feishu.cn/document/task-v2/section/get
...
名称 | 类型 | 描述
---|---|---
section_guid | string | 要获取的自定义分组GUID<br>**示例值**："9842501a-9f47-4ff5-a622-d319eeecb97f"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
