...
resource_type | string | 否 | 资源类型，如提供表示仅查询特定资源下的自定义字段。目前只支持tasklist。<br>**示例值**：tasklist
resource_id | string | 否 | 要查询自定义字段的归属resource_id<br>**示例值**：5ffbe0ca-6600-41e0-a634-2b38cbcf13b8
