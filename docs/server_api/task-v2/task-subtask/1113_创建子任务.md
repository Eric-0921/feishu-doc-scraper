...
> Source: https://open.feishu.cn/document/task-v2/task-subtask/create
...
repeat_rule | string | 否 | 如果设置，则该任务为“重复任务”。该字段表示了重复任务的重复规则。详见[功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“如何使用重复任务？”章节。<br>**示例值**："FREQ=WEEKLY;INTERVAL=1;BYDAY=MO,TU,WE,TH,FR"<br>**数据校验规则**：<br>- 最大长度：`1000` 字符
