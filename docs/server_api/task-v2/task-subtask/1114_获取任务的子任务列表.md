...
> Source: https://open.feishu.cn/document/task-v2/task-subtask/list
...
名称 | 类型 | 描述
---|---|---
task_guid | string | 父任务的全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
