...
> Source: https://open.feishu.cn/document/task-v2/attachment/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查看任务附件(task:attachment:read)<br>查看、创建、删除任务附件(task:attachment:write)
...
名称 | 类型 | 描述
---|---|---
attachment_guid | string | 获取详情的附件GUID。可以通过创建[上传附件](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/upload)接口创建, 或者通过[列取附件](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/attachment/list)接口查询得到。<br>**示例值**："b59aa7a3-e98c-4830-8273-cbb29f89b837"
