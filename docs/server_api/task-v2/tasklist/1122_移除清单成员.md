...
名称 | 类型 | 描述
---|---|---
tasklist_guid | string | 要移除协作人的清单全局唯一ID<br>**示例值**："d300a75f-c56a-4be9-80d1-e47653028ceb"<br>**数据校验规则**：<br>- 最大长度：`100` 字符
...
名称 | 类型 | 必填 | 描述
---|---|---|---
members | member\[\] | 是 | 要移除的member列表。关于member的格式，详见[功能概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/overview)中的“ 如何表示任务和清单的成员？”章节。<br>**数据校验规则**：<br>- 长度范围：`1` ～ `500`
...
role | string | 否 | 清单角色。移除清单成员时该字段不需要填写。<br>**示例值**："editor"<br>**数据校验规则**：<br>- 最大长度：`20` 字符
