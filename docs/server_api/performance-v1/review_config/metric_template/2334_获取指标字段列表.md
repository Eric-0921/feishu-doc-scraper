...
> Source: https://open.feishu.cn/document/performance-v1/review_config/metric_template/query-2
...
type | string | 指标字段类型<br>**可选值有**：<br>- text：文本<br>- number：数字<br>- pencentage：百分比<br>- person：人员单选
