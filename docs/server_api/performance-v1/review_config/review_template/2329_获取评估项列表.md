...
> Source: https://open.feishu.cn/document/performance-v1/review_config/review_template/query-3
...
名称 | 类型 | 必填 | 描述
---|---|---|---
indicator_ids | string\[\] | 否 | 评估项 ID 列表，填写时获取指定的评估项，不填时返回所有评估项<br>**示例值**：["7343513161666707459"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `50`
...
type | string | 评估项类型<br>**可选值有**：<br>- general_review_item：常规评估项<br>- review_item_based_on_key_metric：关键指标评估项<br>- okr_review_item：OKR 评估项<br>- plus：加分项<br>- minus：减分项
