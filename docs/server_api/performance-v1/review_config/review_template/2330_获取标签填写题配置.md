...
> Source: https://open.feishu.cn/document/performance-v1/review_config/review_template/query-2
...
名称 | 类型 | 必填 | 描述
---|---|---|---
tag_based_question_ids | string\[\] | 否 | 标签填写题 ID 列表，获取指定标签填写题的配置数据。如果不传则返回所有<br>**示例值**：["7343513161666707459"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `50`
