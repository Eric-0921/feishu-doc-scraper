...
> Source: https://open.feishu.cn/document/mail-v1/public-mailbox/public_mailbox/remove_to_recycle_bin
...
名称 | 类型 | 描述
---|---|---
public_mailbox_id | string | 公共邮箱地址<br>**示例值**："test_public_mailbox@xxx.xx"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
to_mail_address | string | 否 | 接收删除邮件的邮箱地址，不填则删除该公共邮箱的邮件<br>**示例值**："user@xxx.xx"
