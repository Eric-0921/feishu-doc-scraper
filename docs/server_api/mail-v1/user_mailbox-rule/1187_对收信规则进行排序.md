...
> Source: https://open.feishu.cn/document/mail-v1/user_mailbox-rule/reorder
...
名称 | 类型 | 必填 | 描述
---|---|---|---
rule_ids | string\[\] | 是 | 规则 id 列表，获取方式见 [列出收信规则](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-rule/list)<br>**示例值**：["11111111"]<br>**数据校验规则**：<br>- 最小长度：`1`
