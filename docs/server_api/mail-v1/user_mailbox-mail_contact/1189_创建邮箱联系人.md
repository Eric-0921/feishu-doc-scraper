...
> Source: https://open.feishu.cn/document/mail-v1/user_mailbox-mail_contact/create
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看、创建、更新、删除邮箱联系人(mail:user_mailbox.mail_contact:write)
