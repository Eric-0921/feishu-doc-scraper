...
> Source: https://open.feishu.cn/document/mail-v1/user_mailbox-message/list
...
folder_id | string | 是 | 文件夹 id， 获取方式见 [列出文邮箱文件夹](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-folder/list)<br>**示例值**：INBOX 或者用户文件夹 id
