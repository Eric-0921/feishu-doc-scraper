...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 导出妙记文件(minutes:minute:download)<br>下载妙记的音视频文件(minutes:minutes.media:export)<br>**注意事项**：“导出妙记文件”权限不再开放，已添加权限的应用不受影响，新应用请使用“下载妙记的音视频文件”权限。
