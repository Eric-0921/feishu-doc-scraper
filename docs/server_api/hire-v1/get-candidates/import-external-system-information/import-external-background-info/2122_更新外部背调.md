...
> Source: https://open.feishu.cn/document/hire-v1/get-candidates/import-external-system-information/import-external-background-info/update
...
名称 | 类型 | 描述
---|---|---
external_background_check_id | string | 外部背调 ID，可通过[查询外部背调列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/external_background_check/batch_query)接口获取<br>**示例值**："6960663240925956660"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
external_application_id | string | 是 | 外部投递 ID，可通过[查询外部投递列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/external_application/list)接口获取<br>**示例值**："7003247299220982060"
date | int | 否 | 背调日期，毫秒时间戳（字段类型为：int64）<br>**示例值**：1626602069393
name | string | 否 | 背调名称<br>**示例值**："张三的背调"
result | string | 否 | 背调结果<br>**示例值**："已通过"
attachment_id_list | string\[\] | 否 | 背调附件 ID 列表，可通过[创建附件](https://open.feishu.cn/document/ukTMukTMukTM/uIDN1YjLyQTN24iM0UjN/create_attachment)接口返回<br>**示例值**：["7003247299220982060"]
