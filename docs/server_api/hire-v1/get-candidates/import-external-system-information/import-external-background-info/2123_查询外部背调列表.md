...
> Source: https://open.feishu.cn/document/hire-v1/get-candidates/import-external-system-information/import-external-background-info/batch_query
...
名称 | 类型 | 必填 | 描述
---|---|---|---
external_background_check_id_list | string\[\] | 否 | 外部背调 ID 列表，当传此值时，仅以此值作为条件查询，其他查询条件不生效<br>**示例值**：["6960663240925956660"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `20`
