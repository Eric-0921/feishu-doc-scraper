...
> Source: https://open.feishu.cn/document/hire-v1/get-candidates/import-external-system-information/import-external-interview-info/update
...
名称 | 类型 | 描述
---|---|---
external_interview_id | string | 外部面试 ID，可通过[查询外部面试列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/external_interview/batch_query)接口获取<br>**示例值**："6960663240925956660"
...
conclusion | int | 否 | 面试结果<br>**示例值**：1<br>**可选值有**：<br>- 1：不通过<br>- 2：通过<br>- 3：待定
