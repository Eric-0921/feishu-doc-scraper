...
> Source: https://open.feishu.cn/document/hire-v1/recruitment-related-configuration/job/recruiter
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/hire/v1/jobs/:job_id/recruiter
HTTP Method | GET
...
名称 | 类型 | 描述
---|---|---
job_id | string | 职位 ID, 可通过[获取职位列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/job/list)接口获取<br>**示例值**："6960663240925956555"
...
400 | 1002601 | 职位不存在 | 检查入参`job_id `填写是否正确
