...
> Source: https://open.feishu.cn/document/hire-v1/recruitment-related-configuration/interview-settings/interviewer/list
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 管理面试官信息(hire:interviewer)<br>获取面试官信息(hire:interviewer:readonly)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | int | 否 | 分页大小<br>**示例值**：10<br>**数据校验规则**：<br>- 最大值：`200`
...
user_ids | string\[\] | 否 | 面试官userID列表<br>**示例值**：ou_7dab8a3d3cdcc9da365777c7ad535d62<br>**数据校验规则**：<br>- 最大长度：`50`
verify_status | int | 否 | 认证状态<br>**示例值**：1<br>**可选值有**：<br>- 1：未认证<br>- 2：已认证
earliest_update_time | string | 否 | 最早更新时间，毫秒时间戳<br>**示例值**：1714374796615
latest_update_time | string | 否 | 最晚更新时间，毫秒时间戳<br>**示例值**：1714374796616
...
verify_status | int | 认证状态<br>**可选值有**：<br>- 1：未认证<br>- 2：已认证
