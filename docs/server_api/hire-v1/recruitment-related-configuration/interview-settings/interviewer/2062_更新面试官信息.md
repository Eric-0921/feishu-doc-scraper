...
> Source: https://open.feishu.cn/document/hire-v1/recruitment-related-configuration/interview-settings/interviewer/patch
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 管理面试官信息(hire:interviewer)
...
名称 | 类型 | 描述
---|---|---
interviewer_id | string | 面试官userID<br>**示例值**："ou_7dab8a3d3cdcc9da365777c7ad535d62"
