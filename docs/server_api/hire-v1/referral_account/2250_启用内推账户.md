...
> Source: https://open.feishu.cn/document/hire-v1/referral_account/enable
...
名称 | 类型 | 必填 | 描述
---|---|---|---
referral_account_id | string | 否 | 账户 ID，注册账户后获取：[注册内推账户](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_account/create)<br>**示例值**："6942778198054125570"
