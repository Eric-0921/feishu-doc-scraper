...
> Source: https://open.feishu.cn/document/hire-v1/referral_account/reconciliation
...
名称 | 类型 | 必填 | 描述
---|---|---|---
start_trans_time | string | 是 | 对账时段的起始交易时间，毫秒时间戳<br>**示例值**："1685416831621"
end_trans_time | string | 是 | 对账时段的截止交易时间，毫秒时间戳<br>**示例值**："1685416831622"
trade_details | trade_detail\[\] | 否 | 账户积分变动信息
account_id | string | 是 | 内推账户ID，通过[注册内推账户](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_account/create)生成<br>**示例值**："6930815272790114324"
total_recharge_reward_info | bonus_amount | 否 | 时段内该账户发生在调用方系统的积分之和
point_bonus | int | 否 | 变动的积分数量<br>**示例值**：100
