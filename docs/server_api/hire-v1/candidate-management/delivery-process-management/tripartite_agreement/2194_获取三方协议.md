...
> Source: https://open.feishu.cn/document/hire-v1/candidate-management/delivery-process-management/tripartite_agreement/list
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 更新三方协议(hire:tripartite_agreement)<br>查看三方协议信息(hire:tripartite_agreement:readonly)
...
application_id | string | 否 | 投递 ID，可通过[获取投递列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/application/list)接口获取<br>**示例值**：6930815272790114324
tripartite_agreement_id | string | 否 | 三方协议 ID，由[创建三方协议](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/tripartite_agreement/create)接口返回<br>**示例值**：6930815272790114325
...
state | int | 三方协议状态<br>**可选值有**：<br>- 1：未开始<br>- 2：已申请<br>- 3：学生处理中<br>- 4：公司处理中<br>- 5：学校处理中<br>- 6：已终止<br>- 7：已完成<br>- 8：解约处理中<br>- 9：已解约
