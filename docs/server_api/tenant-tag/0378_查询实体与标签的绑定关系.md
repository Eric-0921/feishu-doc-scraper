...
> Source: https://open.feishu.cn/document/tenant-tag/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查询实体与标签的绑定关系(im:biz_entity_tag_relation:read)<br>查询标签信息(im:tag:read)
