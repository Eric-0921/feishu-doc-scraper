...
> Source: https://open.feishu.cn/document/tenant-tag/patch
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 编辑标签信息(im:tag:write)
...
名称 | 类型 | 描述
---|---|---
tag_id | string | 标签 ID<br>**示例值**："716168xxxxx"
...
id | string | 否 | 标签 ID<br>**示例值**："716168xxxxx"
name | string | 否 | 标签名称<br>**示例值**："标签名称"
i18n_names | tag_i18n_name\[\] | 否 | i18n 多语言名称集合<br>**数据校验规则**：<br>- 长度范围：`0` ～ `40`
locale | string | 是 | 语言<br>**示例值**："zh_cn"
name | string | 否 | 名称<br>**示例值**："标签2"
