...
> Source: https://open.feishu.cn/document/server-docs/admin-v1/badge/badge/update
...
名称 | 类型 | 描述
---|---|---
badge_id | string | 勋章ID<br>**示例值**："m_MzfKDM"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `64` 字符

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
name | string | 是 | 租户内唯一的勋章名称，最多30个字符。<br>**示例值**："激励勋章"
