...
> Source: https://open.feishu.cn/document/server-docs/group/chat-member/event/withdrawn
...
![image.png](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/2faba42d3e4203e1dd899931da6dbfc8_DFXlHNscdw.png?height=278&maxWidth=550&width=1383)
...
基本 | &nbsp;
---|---
事件类型 | im.chat.member.user.withdrawn_v1
...
users | chat.member.user\[\] | 被撤销加群的用户列表
name | string | 用户名字
