...
> Source: https://open.feishu.cn/document/server-docs/group/chat/chat-id-description
...
### 通过群设置页获取群 ID
- 需要将飞书客户端版本升级到 7.60 及以上。
- 支持单聊或群聊两种模式。

群成员可以通过点击右上角的群菜单选项进入群设置页面，查看群 ID。

![img_v3_02uh_0960ac8c-3983-4732-8506-c0702b88869g.jpg](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/42b5a722aca0bcdeefa5df45d703ffe3_6PgRfxdyB0.jpg?height=1606&lazyload=true&maxWidth=350&width=1546)
