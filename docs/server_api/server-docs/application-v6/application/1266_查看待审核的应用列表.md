...
> Source: https://open.feishu.cn/document/server-docs/application-v6/application/underauditlist
...
名称 | 类型 | 必填 | 描述
---|---|---|---
lang | string | 是 | 指定返回的语言<br>**示例值**：zh_cn<br>**可选值有**：<br>- zh_cn：中文<br>- en_us：英文<br>- ja_jp：日文<br>**数据校验规则**：<br>- 最小长度：`1` 字符
