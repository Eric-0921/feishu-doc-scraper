...
> Source: https://open.feishu.cn/document/server-docs/application-v6/application-feedback/patch
...
feedback_id | string | 应用反馈记录id<br>**示例值**："7057888018203574291"
...
status | int | 是 | 反馈处理状态<br>**示例值**：1<br>**可选值有**：<br>- 0：反馈未处理<br>- 1：反馈已处理<br>- 2：反馈处理中<br>- 3：反馈已关闭
operator_id | string | 是 | 反馈处理人员id，租户内用户的唯一标识， ID值与查询参数中的user_id_type 对应<br>**示例值**：ou_9565b69967831233761cc2f11b4c089f
