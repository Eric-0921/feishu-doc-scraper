...
> Source: https://open.feishu.cn/document/server-docs/application-v6/event/created
...
支持的应用类型 | Custom App
权限要求<br>**订阅该事件所需的权限，开启其中任意一项权限即可订阅** | 获取应用信息(admin:app.info:readonly)
...
create_source | string | 应用创建来源<br>**可选值有**：<br>- developer_console：开发者后台<br>- base：多维表格自动化流程创建的应用<br>- app_engine：飞书应用引擎<br>- bot_builder：机器人助手<br>- aily：aily(智能伙伴搭建平台)<br>- unknown：未知来源
