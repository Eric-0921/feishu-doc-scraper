...
> Source: https://open.feishu.cn/document/server-docs/application-v6/event/app-enabled-or-disabled
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnCustomizedEvent("app_status_change", func(ctx context.Context, event *larkevent.EventReq) error {
...
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p1_customized_event("app_status_change", do_customized_event) \
    .build()
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onCustomizedEvent("app_status_change", new CustomEventHandler() {
                @Override
