...
> Source: https://open.feishu.cn/document/server-docs/application-v6/event/app_ticket-events
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnCustomizedEvent("app_ticket", func(ctx context.Context, event *larkevent.EventReq) error {
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onCustomizedEvent("app_ticket", new CustomEventHandler() {
                @Override
