...
> Source: https://open.feishu.cn/document/server-docs/authentication-management/access-token/create-2
...
名称 | 类型 | 必填 | 描述
---|---|---|---
grant_type | string | 是 | 授权类型，**固定值**：<br>**示例值**："authorization_code"
