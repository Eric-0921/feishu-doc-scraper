...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/public-mailbox/public_mailbox-alias/list
...
名称 | 类型 | 描述
---|---|---
public_mailbox_id | string | 公共邮箱id或公共邮箱邮件地址<br>**示例值**："xxxxxx 或 xxx@xx.xxx"
