...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/public-mailbox/public_mailbox/delete
...
名称 | 类型 | 描述
---|---|---
public_mailbox_id | string | 要释放的公共邮箱地址<br>**示例值**："xxxxxx@abc.com"
