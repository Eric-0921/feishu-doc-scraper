...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup-permission_member/create
...
department_id_type | string | 否 | 此次调用中使用的部门ID的类型<br>**示例值**：xxx<br>**可选值有**：<br>- department_id：以自定义department_id来标识部门<br>- open_department_id：以open_department_id来标识部门
