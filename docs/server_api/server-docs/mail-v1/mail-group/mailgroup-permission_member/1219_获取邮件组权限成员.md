...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup-permission_member/get
...
permission_member_id | string | 权限组内成员唯一标识<br>**示例值**："xxxxxxxxxxxxxxx"
