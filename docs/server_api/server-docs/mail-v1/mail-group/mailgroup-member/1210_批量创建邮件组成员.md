...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup-member/batch_create
...
名称 | 类型 | 描述
---|---|---
mailgroup_id | string | The unique ID or email address of a mail group<br>**示例值**："xxxxxxxxxxxxxxx or test_mail_group@xxx.xx"
...
department_id_type | string | 否 | 此次调用中使用的部门ID的类型<br>**示例值**：open_department_id<br>**可选值有**：<br>- department_id：以自定义department_id来标识部门<br>- open_department_id：以open_department_id来标识部门
...
type | string | 否 | 成员类型<br>**示例值**："USER"<br>**可选值有**：<br>- USER：内部用户<br>- DEPARTMENT：部门<br>- COMPANY：全员<br>- EXTERNAL_USER：外部用户<br>- MAIL_GROUP：邮件组<br>- PUBLIC_MAILBOX：member is a public mailbox<br>- OTHER_MEMBER：内部成员
...
type | string | 成员类型<br>**可选值有**：<br>- USER：内部用户<br>- DEPARTMENT：部门<br>- COMPANY：全员<br>- EXTERNAL_USER：外部用户<br>- MAIL_GROUP：邮件组<br>- PUBLIC_MAILBOX：member is a public mailbox<br>- OTHER_MEMBER：内部成员
