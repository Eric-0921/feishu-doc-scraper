...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup/create
...
who_can_send_mail | string | 否 | 谁可发送邮件到此邮件组<br>**示例值**："ALL_INTERNAL_USERS"<br>**可选值有**：<br>- ANYONE：任何人<br>- ALL_INTERNAL_USERS：仅组织内部成员<br>- ALL_GROUP_MEMBERS：仅邮件组成员<br>- CUSTOM_MEMBERS：自定义成员
...
who_can_send_mail | string | 谁可发送邮件到此邮件组<br>**可选值有**：<br>- ANYONE：任何人<br>- ALL_INTERNAL_USERS：仅组织内部成员<br>- ALL_GROUP_MEMBERS：仅邮件组成员<br>- CUSTOM_MEMBERS：自定义成员
