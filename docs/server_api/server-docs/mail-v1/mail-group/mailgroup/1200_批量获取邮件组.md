...
> Source: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup/list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
manager_user_id | string | 否 | 邮件组管理员用户ID，用于获取该用户有管理权限的邮件组<br>**示例值**：ou_xxxxxx
