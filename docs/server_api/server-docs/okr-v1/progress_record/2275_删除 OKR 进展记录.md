...
> Source: https://open.feishu.cn/document/server-docs/okr-v1/progress_record/delete
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 更新 OKR 信息(okr:okr)<br>删除 OKR 进展(okr:okr.progress:delete)
...
名称 | 类型 | 描述
---|---|---
progress_id | string | 待删除的 OKR进展记录 ID，“创建 OKR 进展记录”接口返回值中会提供，也可以通过 OKR 内容相关接口获取。<br>**示例值**："7041857032248410131"
