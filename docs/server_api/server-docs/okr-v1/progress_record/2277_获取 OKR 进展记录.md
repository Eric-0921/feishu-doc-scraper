...
> Source: https://open.feishu.cn/document/server-docs/okr-v1/progress_record/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 获取 OKR 信息(okr:okr:readonly)<br>获取 OKR 进展(okr:okr.progress:readonly)<br>更新 OKR 信息(okr:okr)
