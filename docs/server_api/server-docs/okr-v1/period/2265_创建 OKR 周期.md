...
> Source: https://open.feishu.cn/document/server-docs/okr-v1/period/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
period_rule_id | string | 是 | 周期规则 id<br>**示例值**："6969864184272078374"
start_month | string | 是 | 周期起始年月<br>**示例值**："2022-01"
