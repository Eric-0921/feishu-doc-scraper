...
> Source: https://open.feishu.cn/document/server-docs/okr-v1/period/patch
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 更新 OKR 信息(okr:okr)
...
名称 | 类型 | 描述
---|---|---
period_id | string | 周期id<br>**示例值**："6969864184272078374"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
status | int | 是 | 周期显示状态<br>**示例值**：1<br>**可选值有**：<br>- 1：正常状态<br>- 2：标记失效<br>- 3：隐藏周期
...
status | int | 周期显示状态<br>**可选值有**：<br>- 1：正常状态<br>- 2：标记失效<br>- 3：隐藏周期
