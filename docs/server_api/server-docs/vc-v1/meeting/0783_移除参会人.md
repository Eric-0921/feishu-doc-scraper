...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/meeting/kickout
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 更新会议信息(vc:meeting)
...
名称 | 类型 | 描述
---|---|---
meeting_id | string | 会议ID<br>**示例值**："6911188411932033028"
...
user_type | int | 否 | 用户类型<br>**示例值**：1<br>**可选值有**：<br>- 1：飞书用户<br>- 2：rooms用户<br>- 3：文档用户<br>- 4：neo单品用户<br>- 5：neo单品游客用户<br>- 6：pstn用户<br>- 7：sip用户
...
id | string | 用户ID
user_type | int | 用户类型<br>**可选值有**：<br>- 1：lark用户<br>- 2：rooms用户<br>- 3：文档用户<br>- 4：neo单品用户<br>- 5：neo单品游客用户<br>- 6：pstn用户<br>- 7：sip用户
result | int | 移除结果<br>**可选值有**：<br>- 1：移除成功<br>- 2：移除失败
