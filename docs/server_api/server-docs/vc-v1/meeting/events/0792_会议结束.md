...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/meeting/events/meeting_ended
...
基本 | &nbsp;
---|---
事件类型 | vc.meeting.meeting_ended_v1
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnP2MeetingEndedV1(func(ctx context.Context, event *larkvc.P2MeetingEndedV1) error {
			fmt.Printf("[ OnP2MeetingEndedV1 access ], data: %s\n", larkcore.Prettify(event))
			return nil
		})
...
def do_p2_vc_meeting_meeting_ended_v1(data: lark.vc.v1.P2VcMeetingMeetingEndedV1) -> None:
    print(f'[ do_p2_vc_meeting_meeting_ended_v1 access ], data: {lark.JSON.marshal(data, indent=4)}')

# 注册事件 Register event
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p2_vc_meeting_meeting_ended_v1(do_p2_vc_meeting_meeting_ended_v1) \
    .build()
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onP2MeetingEndedV1(new VcService.P2MeetingEndedV1Handler() {
                @Override
                public void handle(P2MeetingEndedV1 event) throws Exception {
                    System.out.printf("[ onP2MeetingEndedV1 access ], data: %s\n", Jsons.DEFAULT.toJson(event.getEvent()));
                }
            })
            .build();
