...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/room/events/updated
...
path | string\[\] | 层级路径
room_status | room_status_event | 会议室状态
...
resume_notice | boolean | 是否在恢复启用时发送通知给预定了该会议室的员工
