...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/room/list
...
room_level_id | string | 否 | 层级ID，当需要获取租户下会议室列表时，room_level_id可传空<br>**示例值**：omb_4ad1a2c7a2fbc5fc9570f38456931293
