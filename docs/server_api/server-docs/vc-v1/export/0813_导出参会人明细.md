...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/export/participant_list
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 导出视频会议信息(vc:export)
...
user_id | string | 否 | 按参会Lark用户筛选（最多一个筛选条件）<br>**示例值**："ou_3ec3f6a28a0d08c45d895276e8e5e19b"
