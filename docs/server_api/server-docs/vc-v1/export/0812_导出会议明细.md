...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/export/meeting_list
...
meeting_no | string | 否 | 按9位会议号筛选（最多一个筛选条件）<br>**示例值**："123456789"
...
meeting_type | int | 否 | 按会议类型筛选（最多一个筛选条件）<br>**示例值**：2<br>**可选值有**：<br>- 1：全部类型（默认）<br>- 2：视频会议<br>- 3：本地投屏
