...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/export/resource_reservation_list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
room_level_id | string | 是 | 会议室层级id<br>**示例值**："omb_57c9cc7d9a81e27e54c8fabfd02759e7"
...
room_ids | string\[\] | 否 | 待筛选的会议室id列表<br>**示例值**：["omm_eada1d61a550955240c28757e7dec3af"]
is_exclude | boolean | 否 | 若为true表示导出room_ids范围外的会议室，默认为false<br>**示例值**：false
