...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/export/get
...
名称 | 类型 | 描述
---|---|---
task_id | string | 任务id<br>**示例值**："7108646852144136212"
...
msg | string | 错误描述
data | \- | \-
status | int | 任务状态<br>**可选值有**：<br>- 1：处理中<br>- 2：失败<br>- 3：完成
url | string | 文件下载地址
