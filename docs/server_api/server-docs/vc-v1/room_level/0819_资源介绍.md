...
名称 | 类型 | 必填 | 描述
---|---|---|---
room_level_id | string | 是 | 层级ID<br>**示例值**："omb_57c9cc7d9a81e27e54c8fabfd02759e7"
name | string | 是 | 层级名称<br>**示例值**："测试层级"
parent_id | string | 是 | 父层级ID<br>**示例值**："omb_4ad1a2c7a2fbc5fc9570f38456931293"
path | string\[\] | 是 | 层级路径<br>**示例值**：["omb_4ad1a2c7a2fbc5fc9570f38456931293"]
has_child | boolean | 是 | 是否有子层级<br>**示例值**：true
