...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/room_level/list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
room_level_id | string | 否 | 层级ID，当需要获取租户下层级列表时，room_level_id可传空<br>**示例值**：omb_4ad1a2c7a2fbc5fc9570f38456931293
page_size | int | 否 | 分页尺寸大小<br>**示例值**：10<br>**数据校验规则**：<br>- 最大值：`100`
