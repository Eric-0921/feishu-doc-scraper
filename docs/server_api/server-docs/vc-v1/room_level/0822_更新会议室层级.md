...
> Source: https://open.feishu.cn/document/server-docs/vc-v1/room_level/patch
...
名称 | 类型 | 描述
---|---|---
room_level_id | string | 层级ID<br>**示例值**："omb_4ad1a2c7a2fbc5fc9570f38456931293"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `100` 字符
