...
> Source: https://open.feishu.cn/document/server-docs/task-v1/task-reminder/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
relative_fire_minute | int | 是 | 相对于截止时间的提醒时间（如提前 30 分钟，截止时间后 30 分钟，则为 -30） 任务没有截止时间则为全天任务(截止时间为0)<br>**示例值**：30
