...
> Source: https://open.feishu.cn/document/server-docs/task-v1/task/complete
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看、创建、编辑和删除飞书任务（历史版本）(task:task)
...
名称 | 类型 | 描述
---|---|---
task_id | string | 任务 ID，可通过[创建任务](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/task-v1/task/create)时响应体中的id字段获取<br>**示例值**："bb54ab99-d360-434f-bcaa-a4cc4c05840e"
