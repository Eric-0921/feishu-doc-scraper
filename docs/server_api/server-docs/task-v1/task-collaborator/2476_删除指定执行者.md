...
> Source: https://open.feishu.cn/document/server-docs/task-v1/task-collaborator/delete
...
collaborator_id | string | 任务执行者 ID（Open ID或User ID，由user_id_type指定）<br>**示例值**："ou_99e1a581b36ecc4862cbfbce123f346a"
