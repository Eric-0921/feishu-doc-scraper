...
> Source: https://open.feishu.cn/document/server-docs/task-v1/overview
...
页面/场景 | path | 参数 | 备注
---|---|---|---
任务详情 | /client/todo/detail | - `guid: string` **[required]** <br>- ` authscene?:``1|2`<br>*MESSAGE* = 1;<br>*PANO* = 2;<br>传参使用数字，eg：xxxxx?authscene=2<br>- `authid?: string`<br>- `navigateStyle?: 'push'|'present'`<br>`?` 后缀的参数名，表示可选参数 | 打开 todo 详情<br>示例：[https://applink.feishu.cn/client/todo/detail?guid=todoGuidStrin](https://applink.feishu.cn/client/todo/detail?guid=todoGuidStrin)<br>`navigateStyle` <br>仅移动端使用，用于控制进入详情页时的UI样式，「push」为从右至左，「present」为从下至上
任务中心 | /client/todo/open | 无 | 切换至 Todo Tab <br>示例：[https://applink.feishu.cn/client/todo/open](https://applink.feishu.cn/client/todo/open)
