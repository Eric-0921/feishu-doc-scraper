...
> Source: https://open.feishu.cn/document/server-docs/task-v1/task-follower/delete
...
follower_id | string | 任务关注人 ID（Open ID或User ID，由user_id_type指定）<br>**示例值**："ou_87e1a581b36ecc4862cbfbce473f346a"
