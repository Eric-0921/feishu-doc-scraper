...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/ticket-management/ticket_customized_field/update-ticket-customized-field
...
名称 | 类型 | 必填 | 描述
---|---|---|---
display_name | string | 否 | 名称<br>**示例值**："test dropdown"
position | string | 否 | 字段在列表后台管理列表中的位置<br>**示例值**："3"
description | string | 否 | 描述<br>**示例值**："下拉示例"
visible | boolean | 否 | 是否可见<br>**示例值**：true
required | boolean | 否 | 是否必填<br>**示例值**：false
