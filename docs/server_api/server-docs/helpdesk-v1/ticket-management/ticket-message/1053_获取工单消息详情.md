...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/ticket-management/ticket-message/list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
time_start | int | 否 | 起始时间<br>**示例值**：1617960686
time_end | int | 否 | 结束时间<br>**示例值**：1617960687
page | int | 否 | 页数ID<br>**示例值**：1
page_size | int | 否 | 消息数量，最大200，默认20<br>**示例值**：10
