...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/ticket-management/ticket/ticket_image
...
名称 | 类型 | 必填 | 描述
---|---|---|---
ticket_id | string | 是 | 工单ID<br>**示例值**：12345
msg_id | string | 是 | 消息ID<br>[查询消息ID](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/helpdesk-v1/ticket-message/list)<br>**示例值**：12345
index | int | 否 | index，当消息类型为post时，需指定图片index，index从0开始。当消息类型为img时，无需index<br>**示例值**：0
