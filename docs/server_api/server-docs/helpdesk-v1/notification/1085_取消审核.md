...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/notification/cancel_approve
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/helpdesk/v1/notifications/:notification_id/cancel_approve
HTTP Method | POST
...
名称 | 类型 | 描述
---|---|---
notification_id | string | 唯一ID<br>**示例值**："6981801914270744596"
