...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/agent-function/agent_skill/delete
...
名称 | 类型 | 描述
---|---|---
agent_skill_id | string | agent group id<br>**示例值**："test-skill-id"
