...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/agent-function/agent_skill/get
...
名称 | 类型 | 描述
---|---|---
agent_skill_id | string | agent skill id<br>**示例值**："6941215891786825756"
