...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/agent-function/agent-schedules/list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
status | int\[\] | 是 | 筛选条件<br>- 1：online客服<br>- 2：offline(手动)客服<br>- 3：off duty(下班)客服<br>- 4：移除客服<br>在 GET 请求中传入多个值的格式为 `status=1&status=2`。<br>**示例值**：1
