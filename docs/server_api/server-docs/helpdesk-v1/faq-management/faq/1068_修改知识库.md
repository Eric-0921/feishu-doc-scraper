...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/faq-management/faq/patch
...
answer_richtext | richtext\[\] | 否 | 富文本答案和答案必须有一个必填。Json Array格式，富文本结构请见[了解更多: 富文本](https://open.feishu.cn/document/ukTMukTMukTM/uITM0YjLyEDN24iMxQjN)<br>**示例值**：[{"content":"答案","type":"text"},{"content":"\n","type":"text"}]
