...
> Source: https://open.feishu.cn/document/server-docs/helpdesk-v1/faq-management/category/patch
...
名称 | 类型 | 描述
---|---|---
id | string | category id<br>**示例值**："6948728206392295444"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
name | string | 否 | 名称<br>**示例值**："创建团队和邀请成员"
parent_id | string | 否 | 父知识库分类ID<br>**示例值**："0"
