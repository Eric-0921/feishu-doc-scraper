...
> Source: https://open.feishu.cn/document/server-docs/historic-version//event/user-status-changed
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnCustomizedEvent("user_status_change", func(ctx context.Context, event *larkevent.EventReq) error {
...
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p1_customized_event("user_status_change", do_customized_event) \
    .build()
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onCustomizedEvent("user_status_change", new CustomEventHandler() {
                @Override
