...
> Source: https://open.feishu.cn/document/server-docs/historic-version/hire_internal/offer/get
...
HTTP Method | GET
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取 offer 申请表信息
...
名称 | 类型 | 描述
---|---|---
offer_schema_id | string | offer申请表的ID *必需属性<br>**示例值**："1231231231231"
...
&emsp;∟&nbsp;scenario | int | offer申请表使用场景<br>**可选值有**：<br>- `1`：Offer审批表
...
&emsp;&emsp;&emsp;∟&nbsp;active_status | int | 选项当前是否启用<br>**可选值有**：<br>- `1`：进行中<br>- `2`：已终止
