...
> Source: https://open.feishu.cn/document/server-docs/historic-version//user/obtain-a-role-list
...
HTTP Method | GET
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 获取角色 <br>读取通讯录
