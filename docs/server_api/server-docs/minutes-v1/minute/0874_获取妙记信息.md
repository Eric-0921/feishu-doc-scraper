...
> Source: https://open.feishu.cn/document/server-docs/minutes-v1/minute/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 查看、创建、编辑及管理妙记文件(minutes:minutes)<br>获取妙记的基本信息(minutes:minutes.basic:read)<br>查看妙记文件(minutes:minutes:readonly)
