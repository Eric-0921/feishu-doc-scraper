...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/custom_attr/events/updated
...
基本 | &nbsp;
---|---
事件类型 | contact.custom_attr_event.updated_v3
...
event | \- | \-
object | custom_attr_event | 变更后信息
contact_field_key | string\[\] | 通讯录字段键值
allow_open_query | boolean | 开关是否打开
old_object | custom_attr_event | 变更前信息
contact_field_key | string\[\] | 通讯录字段键值
allow_open_query | boolean | 开关是否打开
