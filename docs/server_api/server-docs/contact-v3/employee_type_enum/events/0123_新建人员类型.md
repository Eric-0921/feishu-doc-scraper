...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/employee_type_enum/events/created
...
基本 | &nbsp;
---|---
事件类型 | contact.employee_type_enum.created_v3
...
event | \- | \-
new_enum | employee_type_enum | 新建的人员类型选项信息。
