...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/employee_type_enum/events/updated

---

# 修改人员类型名称

当应用订阅该事件后，若果更新了人员类型的选项内容（包括默认内容 content 参数和国际化内容 i18n_content），则会触发该事件。
...
基本 | &nbsp;
---|---
事件类型 | contact.employee_type_enum.updated_v3
