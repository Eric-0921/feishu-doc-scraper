...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/unit/bind_department
...
department_id | string | 是 | 单位关联的部门 ID，ID 类型与 department_id_type 的取值保持一致。<br>部门 API 提供了多种获取部门 ID 的方式，如[获取子部门列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/children)、[获取父部门信息](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/parent)、[搜索部门](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/search)，你可以选择合适的 API 进行查询。<br>**示例值**："od-4e6ac4d14bcd5071a37a39de902c7141"
