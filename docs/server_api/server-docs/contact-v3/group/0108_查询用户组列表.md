...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/group/simplelist
...
type | int | 否 | 用户组类型。<br>**示例值**：1<br>**可选值有**：<br>- 1：普通用户组<br>- 2：动态用户组<br>**默认值**：`1`
...
member_department_count | int | 普通用户组成员中的部门数量。<br>**说明**：动态用户组成员中没有部门。
