...
> Source: https://open.feishu.cn/document/server-docs/contact-v3/job_level/list
...
name | string | 否 | 职级名称。<br>- 传入该字段时，可查询指定职级名称对应的职级信息（不支持模糊查询）。<br>- 不传入该字段时，查询当前租户下所以职级的信息。<br>**示例值**：高级专家<br>**数据校验规则**：<br>- 长度范围：`1` ～ `255` 字符
