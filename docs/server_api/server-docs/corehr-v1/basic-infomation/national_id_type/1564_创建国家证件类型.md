...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/basic-infomation/national_id_type/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
country_region_id | string | 是 | 国家 / 地区<br>**示例值**："6862995747139225096"
name | i18n\[\] | 是 | 名称
lang | string | 是 | 名称信息的语言<br>**示例值**："zh-CN"
value | string | 是 | 名称信息的内容<br>**示例值**："张三"
active | boolean | 是 | 是否启用<br>**示例值**：true
validation_rule | string | 是 | 校验规则（正则表达式），若不设置校验，可以传入".*"<br>**示例值**："^\d{9}$"
validation_rule_description | i18n\[\] | 否 | 校验规则描述
lang | string | 是 | 名称信息的语言<br>**示例值**："zh-CN"
value | string | 是 | 名称信息的内容<br>**示例值**："张三"
code | string | 是 | 编码<br>**示例值**："AUS-TFN"
