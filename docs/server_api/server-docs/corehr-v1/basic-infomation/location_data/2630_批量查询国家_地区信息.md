...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/basic-infomation/location_data/list
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/corehr/v1/country_regions
HTTP Method | GET
