...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/basic-infomation/location_data/list-3
...
subdivision_id | string | 否 | 省份/行政区id，填写后只查询该省份/行政区下的城市/区域<br>**示例值**：100
