...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/basic-infomation/location_data/list-2
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 获取基础数据信息(corehr:common_data.basic_data:read)<br>获取核心人事信息(corehr:corehr:readonly)<br>更新核心人事信息(corehr:corehr)
...
country_region_id | string | 否 | 国家/地区id，填写后只查询该国家/地区下的省份/行政区<br>**示例值**：100
