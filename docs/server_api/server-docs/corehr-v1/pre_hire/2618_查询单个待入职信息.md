...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/pre_hire/get
...
名称 | 类型 | 描述
---|---|---
pre_hire_id | string | 待入职ID，可从[搜索待入职人员信息](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/pre_hire/search)接口获取<br>**示例值**："121215"
