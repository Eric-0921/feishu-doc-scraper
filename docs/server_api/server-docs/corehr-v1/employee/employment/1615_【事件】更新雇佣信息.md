...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/employee/employment/updated
...
基本 | &nbsp;
---|---
事件类型 | corehr.employment.updated_v1
...
event | \- | \-
employment_id | string | 被更新的雇佣信息 ID
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnP2EmploymentUpdatedV1(func(ctx context.Context, event *larkcorehr.P2EmploymentUpdatedV1) error {
			fmt.Printf("[ OnP2EmploymentUpdatedV1 access ], data: %s\n", larkcore.Prettify(event))
			return nil
		})
...
def do_p2_corehr_employment_updated_v1(data: lark.corehr.v1.P2CorehrEmploymentUpdatedV1) -> None:
    print(f'[ do_p2_corehr_employment_updated_v1 access ], data: {lark.JSON.marshal(data, indent=4)}')

# 注册事件 Register event
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p2_corehr_employment_updated_v1(do_p2_corehr_employment_updated_v1) \
    .build()
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onP2EmploymentUpdatedV1(new CorehrService.P2EmploymentUpdatedV1Handler() {
                @Override
                public void handle(P2EmploymentUpdatedV1 event) throws Exception {
                    System.out.printf("[ onP2EmploymentUpdatedV1 access ], data: %s\n", Jsons.DEFAULT.toJson(event.getEvent()));
                }
            })
            .build();
...
wsClient.start({
    ...
    eventDispatcher: new Lark.EventDispatcher({}).register({
        'corehr.employment.updated_v1': async (data) => {
            console.log(data);
        }
    })
});
