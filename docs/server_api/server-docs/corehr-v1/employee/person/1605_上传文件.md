...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/employee/person/upload
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 读写飞书人事的附件信息(corehr:file:write)<br>更新核心人事信息(corehr:corehr)<br>读写员工的个人信息(corehr:person:write)
