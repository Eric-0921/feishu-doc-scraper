...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/job-management/job_family/list
...
page_size | string | 是 | 分页大小，最大值支持传100<br>- 最少1个字符，最多200个字符<br>**示例值**：100
...
effective_time | string | 当前版本生效时间<br>- 返回格式：YYYY-MM-DD 00:00:00（最小单位到日）<br>- 日期范围:1900-01-01 00:00:00～9999-12-31 00:00:00
expiration_time | string | 当前版本失效时间<br>- 返回格式：YYYY-MM-DD 00:00:00（最小单位到日）<br>- 日期范围:1900-01-01 00:00:00～9999-12-31 00:00:00
code | string | 序列编码
description | i18n\[\] | 描述
lang | string | 语言
value | string | 内容
