...
> Source: https://open.feishu.cn/document/server-docs/corehr-v1/job-management/job_level/list
...
page_size | string | 是 | 分页大小，最小支持传1，最大支持传100<br>- 最小长度为 1 字符，最大长度为100字符<br>**示例值**：100
