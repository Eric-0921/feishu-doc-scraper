...
> Source: https://open.feishu.cn/document/server-docs/verification-v1/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看租户认证信息(verification:verification_information:readonly)
