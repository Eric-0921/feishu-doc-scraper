...
> Source: https://open.feishu.cn/document/server-docs/tenant-v2/tenant-product_assign_info/query
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查询租户下的席位信息(tenant:tenant.product_assign_info:read)
