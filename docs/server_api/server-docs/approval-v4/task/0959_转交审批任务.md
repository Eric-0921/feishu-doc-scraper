...
> Source: https://open.feishu.cn/document/server-docs/approval-v4/task/transfer
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/approval/v4/tasks/transfer
HTTP Method | POST
...
user_id | string | 是 | 当前审批人的用户 ID，ID 类型与查询参数 user_id_type 取值一致。<br>**示例值**："f7cb567e"
comment | string | 否 | 审批意见<br>**示例值**："OK"
transfer_user_id | string | 是 | 被转交人的用户 ID，ID 类型与查询参数 user_id_type 取值一致。<br>**示例值**："f4ip317q"
