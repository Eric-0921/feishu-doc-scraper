...
> Source: https://open.feishu.cn/document/server-docs/ai/speech_to_text-v1/stream_recognize
...
action | int | 是 | 数据流标记：1 首包，2 正常结束，等待结果返回，3 中断数据流不返回最终结果，0 传输语音中间的数据包<br>**示例值**：1
