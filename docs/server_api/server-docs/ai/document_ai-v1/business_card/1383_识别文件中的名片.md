...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 识别名片(document_ai:business_card:recognize)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 是 | 识别名片的源文件（支持 JPG / PNG / PDF）<br>**示例值**：file binary
...
type | string | 识别的字段种类<br>**可选值有**：<br>- contact_names：联系人名<br>- company_names：公司名<br>- departments：部门<br>- job_titles：职位<br>- emails：邮箱<br>- websites：网站<br>- addresses：地址<br>- mobile_phones：移动电话<br>- work_phones：工作电话<br>- other_phones：其他电话<br>- faxes：传真
