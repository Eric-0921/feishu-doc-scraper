...
> Source: https://open.feishu.cn/document/server-docs/ai/optical_char_recognition-v1/basic_recognize
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 图片识别(optical_char_recognition:image)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
image | string | 否 | base64 后的图片数据<br>**示例值**："base64后的图片二进制数据"
