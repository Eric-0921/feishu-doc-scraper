...
> Source: https://open.feishu.cn/document/server-docs/baike-v1/entity/highlight
...
名称 | 类型 | 必填 | 描述
---|---|---|---
text | string | 是 | 需要识别词条的内容（不超过1000字）<br>**示例值**："词典是飞书提供的一款知识管理工具"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `1000` 字符
