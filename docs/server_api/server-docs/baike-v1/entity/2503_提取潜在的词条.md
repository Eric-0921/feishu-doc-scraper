...
> Source: https://open.feishu.cn/document/server-docs/baike-v1/entity/extract
...
名称 | 类型 | 必填 | 描述
---|---|---|---
text | string | 否 | 需要被提取词条的文本（不会过滤租户中已成为词条的内容）<br>**示例值**："飞书词典是一部高效汇聚企业内各类信息，并可由企业成员参与编辑的在线词典"<br>**数据校验规则**：<br>- 最大长度：`128` 字符
