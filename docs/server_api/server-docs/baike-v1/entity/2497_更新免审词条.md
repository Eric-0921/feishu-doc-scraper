...
> Source: https://open.feishu.cn/document/server-docs/baike-v1/entity/update
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 创建、更新飞书词典免审词条(baike:entity:exempt_review)
...
名称 | 类型 | 描述
---|---|---
entity_id | string | 实体词 ID<br>**示例值**："enterprise_40217521"
