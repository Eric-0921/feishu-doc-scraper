...
> Source: https://open.feishu.cn/document/server-docs/baike-v1/classification/list
...
page_token | string | 否 | 分页标记，第一次请求不填，表示从头开始遍历；分页查询结果还有更多项时会同时返回新的 page_token，下次遍历可采用该 page_token 获取查询结果<br>**示例值**：408ecac018b2e3518db37275e812****bb8ad3e755fc886f322ac6c430ba
