...
> Source: https://open.feishu.cn/document/server-docs/search-v2/open-search/schema/patch
...
名称 | 类型 | 描述
---|---|---
schema_id | string | 用户自定义数据范式的唯一标识<br>**示例值**："custom_schema_id"<br>**数据校验规则**：<br>- 最大长度：`40` 字符<br>- 正则校验：`^[a-zA-Z][a-zA-Z0-9-_].*$`
