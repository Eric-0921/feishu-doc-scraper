...
> Source: https://open.feishu.cn/document/server-docs/search-v2/suite-search/create
...
page_token | string | 否 | 分页标记，第一次请求不填，表示从头开始遍历；分页查询结果还有更多项时会同时返回新的 page_token，下次遍历可采用该 page_token 获取查询结果<br>**示例值**：9e91187f9107ef4d43cd71c3722cd97665e6cec51bf30a06328839bc9867

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
query | string | 是 | 搜索关键词<br>**示例值**："测试消息"
from_ids | string\[\] | 否 | 消息来自user_id列表<br>**示例值**：["ou_7dab8a3d3cdcc9da365777c7ad535d62"]
chat_ids | string\[\] | 否 | 消息所在chat_id列表<br>**示例值**：["oc_a0553eda9014c201e6969b478895c230"]
message_type | string | 否 | 消息类型(file/image/media)<br>**示例值**："image"<br>**可选值有**：<br>- file：文件<br>- image：图片<br>- media：视频
at_chatter_ids | string\[\] | 否 | at用户user_id列表<br>**示例值**：["ou_7dab8a3d3cdcc9da365777c7ad535d62"]
from_type | string | 否 | 消息来自类型(bot/user)<br>**示例值**："user"<br>**可选值有**：<br>- bot：机器人<br>- user：用户
chat_type | string | 否 | 会话类型(group_chat/p2p_chat)<br>**示例值**："group_chat"<br>**可选值有**：<br>- group_chat：群聊<br>- p2p_chat：单聊
start_time | string | 否 | 消息发送起始时间<br>**示例值**："1609296809"
end_time | string | 否 | 消息发送结束时间<br>**示例值**："1609296809"
