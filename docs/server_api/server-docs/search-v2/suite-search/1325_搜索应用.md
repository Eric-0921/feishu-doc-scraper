...
> Source: https://open.feishu.cn/document/server-docs/search-v2/suite-search/create-2
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取应用搜索结果(search:app)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
query | string | 是 | 搜索关键词<br>**示例值**："测试应用"
