...
> Source: https://open.feishu.cn/document/server-docs/docs/drive-v1/file-version/get
...
名称 | 类型 | 描述
---|---|---
file_token | string | 源文档的 token。获取方式参考 [如何获取云文档相关 token](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。<br>**示例值**："shtbcqqoXZJaKYrfN5IHQgabcef"
version_id | string | 版本文档的版本标识<br>**示例值**："fnJfyX"
