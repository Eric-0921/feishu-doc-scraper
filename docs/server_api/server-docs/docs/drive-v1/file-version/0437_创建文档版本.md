...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看、创建、删除文档版本(drive:drive:version)
...
obj_type | string | 否 | 源文档的类型<br>**注意**：该参数必填，请忽略左侧必填列显示的“否”。<br>**示例值**："docx"<br>**可选值有**：<br>- docx：新版文档<br>- sheet：电子表格
...
status | string | 版本文档的状态<br>**可选值有**：<br>- 0：正常状态<br>- 1：该版本已被删除<br>- 2：回收站状态
