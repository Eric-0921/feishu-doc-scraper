...
> Source: https://open.feishu.cn/document/server-docs/docs/drive-v1/event/list/file-edited
...
event | \- | \-
file_type | string | 云文档类型，支持以下枚举：<br>- doc：旧版文档。已不推荐使用<br>- docx：新版文档<br>- sheet：电子表格<br>- bitable：多维表格<br>- slides：幻灯片
