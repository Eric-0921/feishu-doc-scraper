...
> Source: https://open.feishu.cn/document/server-docs/docs/drive-v1/event/list/delete-file-to-trash-can
...
权限要求<br>**订阅该事件所需的权限，开启其中任意一项权限即可订阅**<br>开启任一权限即可 | 查看、评论、编辑和管理多维表格(drive:drive)<br>查看、评论、编辑和管理云空间中所有文件(docs:doc)<br>查看、评论、编辑和管理云空间中所有文件(sheets:spreadsheet)<br>接收云文档删除事件(docs:event.document_deleted:read)
