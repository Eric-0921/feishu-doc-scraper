...
> Source: https://open.feishu.cn/document/server-docs/docs/CommentAPI/list-2
...
file_type | string | 是 | 云文档类型<br>**示例值**：docx<br>**可选值有**：<br>- doc：旧版文档，已不推荐使用<br>- docx：新版文档类型<br>- sheet：电子表格类型<br>- file：文件夹类型<br>- slides：幻灯片
