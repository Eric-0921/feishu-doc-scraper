...
> Source: https://open.feishu.cn/document/server-docs/docs/CommentAPI/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file_type | string | 是 | 云文档类型<br>**示例值**：doc<br>**可选值有**：<br>- doc：旧版文档，已不推荐使用<br>- docx：新版文档
...
type | string | 是 | 回复内容的元素类型<br>**示例值**："text_run"<br>**可选值有**：<br>- text_run：普通文本<br>- docs_link：云文档链接<br>- person：at 联系人
