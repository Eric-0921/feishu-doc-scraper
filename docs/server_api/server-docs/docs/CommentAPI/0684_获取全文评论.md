...
> Source: https://open.feishu.cn/document/server-docs/docs/CommentAPI/get
...
名称 | 类型 | 描述
---|---|---
file_token | string | 文档 Token<br>**示例值**："doccnHh7U87HOFpii5u5G*****"
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file_type | string | 是 | 云文档类型<br>**示例值**：doc<br>**可选值有**：<br>- doc：旧版文档，已不推荐使用<br>- sheet：表格<br>- file：文件<br>- docx：新版文档
