...
> Source: https://open.feishu.cn/document/server-docs/docs/sheets-v3/spreadsheet-sheet-filter_view/spreadsheet-sheet-filter_view-condition/delete
...
condition_id | string | 要删除所有筛选条件的列，用字母表示。<br>**示例值**："E"
