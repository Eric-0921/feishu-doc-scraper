...
> Source: https://open.feishu.cn/document/server-docs/docs/sheets-v3/spreadsheet-sheet-filter_view/spreadsheet-sheet-filter_view-condition/get
...
condition_id | string | 要查询的筛选视图的列<br>**示例值**："E"
...
msg | string | 错误描述
data | \- | \-
condition | filter_view_condition | 指定列的筛选条件信息
condition_id | string | 指定列的编号
