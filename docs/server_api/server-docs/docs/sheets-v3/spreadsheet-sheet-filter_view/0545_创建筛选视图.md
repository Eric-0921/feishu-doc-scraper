...
> Source: https://open.feishu.cn/document/server-docs/docs/sheets-v3/spreadsheet-sheet-filter_view/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
filter_view_id | string | 否 | 自定义筛选视图 ID。不填将由系统生成。长度需为 10 字符。字符可以是 0-9 数字、a-z、A-Z 字母或其组合。<br>**示例值**："pH9hbVcCXA"
filter_view_name | string | 否 | 自定义筛选视图名称。不填将由系统生成。长度不超过100 个字符。<br>**示例值**："筛选视图 1"
