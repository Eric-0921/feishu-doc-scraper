...
> Source: https://open.feishu.cn/document/server-docs/docs/sheets-v3/spreadsheet-sheet-filter_view/get
...
**注意事项**：要获取所有筛选视图的信息，可调用[查询筛选视图](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view/query)。
...
### cURL 请求示例
```bash
curl --location --request GET 'https://open.feishu.cn/open-apis/sheets/v3/spreadsheets/shtcnspY6YDVPxWjhG09Qcabcef/sheets/phwh0X/filter_views/1234567890' \
...
msg | string | 错误描述
data | \- | \-
filter_view | filter_view | 筛选视图的信息
