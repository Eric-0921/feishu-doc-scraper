...
> Source: https://open.feishu.cn/document/server-docs/docs/sheets-v3/spreadsheet/patch
...
名称 | 类型 | 必填 | 描述
---|---|---|---
title | string | 否 | 新的电子表格标题。参数为空时，表格标题将显示为“未命名表格”或本地语言环境对应内容。<br>**示例值**："Sales sheet"
