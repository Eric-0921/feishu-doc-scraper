...
> Source: https://open.feishu.cn/document/server-docs/docs/bitable-v1/app-table-view/list
...
view_public_level | string | 视图公共等级<br>**可选值有**：<br>- Public：公共视图<br>- Locked：锁定视图<br>- Private：个人视图
