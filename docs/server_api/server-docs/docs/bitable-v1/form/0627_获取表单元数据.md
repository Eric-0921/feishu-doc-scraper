...
> Source: https://open.feishu.cn/document/server-docs/docs/bitable-v1/form/get
...
shared | boolean | 是否开启表单分享，使表单支持填写。可选值：<br>- true：支持填写<br>- false：不支持填写
...
submit_limit_once | boolean | 是否将填写次数限制为一次。可选值：<br>- true：设置表单仅支持填写一次<br>- false：不限制表单填写次数
