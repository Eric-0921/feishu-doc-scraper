...
名称 | 类型 | 必填 | 描述
---|---|---|---
task_type | string | 是 | 任务类型<br>**示例值**：move<br>**可选值有**：<br>- move：[移动云空间文档至知识空间](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/move_docs_to_wiki)任务
