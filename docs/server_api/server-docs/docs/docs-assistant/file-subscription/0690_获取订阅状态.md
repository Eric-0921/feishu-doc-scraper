...
> Source: https://open.feishu.cn/document/server-docs/docs/docs-assistant/file-subscription/get
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 获取云文档订阅状态(docs:document.subscription:read)<br>查看、评论、编辑和管理云空间中所有文件(drive:drive)<br>查看、评论和下载云空间中所有文件(drive:drive:readonly)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file_type | string | 是 | 文档类型<br>**示例值**："doc"<br>**可选值有**：<br>- doc：旧版文档<br>- docx：新版文档<br>- wiki：云空间
