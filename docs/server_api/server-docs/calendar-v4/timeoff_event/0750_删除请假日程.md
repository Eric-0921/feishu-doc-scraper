...
> Source: https://open.feishu.cn/document/server-docs/calendar-v4/timeoff_event/delete
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 删除请假日程(calendar:time_off:delete)<br>创建或删除请假日程(calendar:timeoff)
...
名称 | 类型 | 描述
---|---|---
timeoff_event_id | string | 请假日程 ID，在创建请假日程时从返回结果中获取。<br>**示例值**："timeoff:XXXXXX-XXXX-0917-1623-aa493d591a39"
