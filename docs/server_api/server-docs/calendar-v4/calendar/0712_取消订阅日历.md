...
> Source: https://open.feishu.cn/document/server-docs/calendar-v4/calendar/unsubscribe
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/calendar/v4/calendars/:calendar_id/unsubscribe
HTTP Method | POST
...
名称 | 类型 | 描述
---|---|---
calendar_id | string | 日历 ID。<br>你可以调用以下接口获取某一日历的 ID。<br>- [查询主日历信息](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/primary)<br>- [查询日历列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/list)<br>- [搜索日历](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/search)<br>**示例值**："feishu.cn_xxxxxxxxxx@group.calendar.feishu.cn"
...
400 | 191007 | target calendar is already unsubscribed | 目标日历已经取消订阅，你需要检查并改为正确的日历 ID。
400 | 191008 | primary calendar can not be unsubscribed | 当前身份的主日历不能被取消订阅。
