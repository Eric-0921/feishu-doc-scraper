...
> Source: https://open.feishu.cn/document/server-docs/calendar-v4/exchange_binding/delete
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 更新日历及日程信息(calendar:calendar)<br>删除 Exchange 绑定关系(calendar:exchange.bindings:delete)
