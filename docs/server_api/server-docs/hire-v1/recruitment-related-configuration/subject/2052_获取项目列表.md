...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/recruitment-related-configuration/subject/list
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取项目信息(hire:subject:readonly)
...
page_size | int | 否 | 分页大小, 不能超过 200<br>**示例值**：100<br>**默认值**：`1`
...
active_status | int | 状态<br>**可选值有**：<br>- 1：已启用<br>- 2：已禁用
application_limit | int | 投递职位数上限，已废弃
