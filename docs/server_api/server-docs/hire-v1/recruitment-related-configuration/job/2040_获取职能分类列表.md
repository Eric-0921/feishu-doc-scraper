...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/recruitment-related-configuration/job/list-3
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | int | 否 | 分页大小, 不能超过 50, 默认10<br>**示例值**：10<br>**数据校验规则**：<br>- 最大值：`50`
