...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/candidate-management/recruitment-process-follow-up/list-4
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/hire/v1/interview_tasks
HTTP Method | GET
接口频率限制 | [1000 次/分钟、50 次/秒](https://open.feishu.cn/document/ukTMukTMukTM/uUzN04SN3QjL1cDN)
支持的应用类型 | Custom App、Store App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取面试信息(hire:interview:readonly)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | int | 否 | 分页大小, 默认10，不能超过 20<br>**示例值**：10<br>**默认值**：`10`<br>**数据校验规则**：<br>- 最大值：`20`
...
user_id | string | 是 | 面试官 ID，需要与user_id_type类型保持一致<br>**示例值**：ou_e6139117c300506837def50545420c6a
activity_status | int | 否 | 任务状态<br>**示例值**：1<br>**可选值有**：<br>- 1：未开始<br>- 2：未评价<br>- 3：已评价<br>- 5：已终止
...
activity_status | int | 任务状态<br>**可选值有**：<br>- 1：未开始<br>- 2：未评价<br>- 3：已评价<br>- 5：已终止
