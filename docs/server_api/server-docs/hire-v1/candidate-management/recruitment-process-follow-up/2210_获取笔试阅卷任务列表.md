...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/candidate-management/recruitment-process-follow-up/list-2
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取笔试信息(hire:exam:readonly)
...
user_id | string | 是 | 阅卷人 ID，需要与user_id_type类型保持一致<br>**示例值**：ou_e6139117c300506837def50545420c6a
activity_status | int | 否 | 任务状态，不传则查询全部记录<br>**示例值**：1<br>**可选值有**：<br>- 1：待阅卷<br>- 2：已阅卷
...
activity_status | int | 任务状态<br>**可选值有**：<br>- 1：待阅卷<br>- 2：已阅卷
