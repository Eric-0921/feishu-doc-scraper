...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/candidate-management/talent/onboard_status
...
名称 | 类型 | 描述
---|---|---
talent_id | string | 人才ID，可通过[获取人才列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/list)接口获取<br>**示例值**："6960663240925956661"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
operation | int | 是 | 操作类型<br>**示例值**：1<br>**可选值有**：<br>- 1：入职<br>- 2：离职
