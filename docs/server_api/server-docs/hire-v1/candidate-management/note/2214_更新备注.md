...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/candidate-management/note/patch
...
名称 | 类型 | 描述
---|---|---
note_id | string | 备注 ID，可通过[获取备注列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/note/list)获取<br>**示例值**："6960663240925956401"
...
operator_id | string | 否 | 更新人 ID，请传入与`user_id_type`相匹配的ID<br>**示例值**："ou_f476cb099ac9227c9bae09ce46112579"
