...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/ecological-docking/eco_account_custom_field/batch_delete
...
custom_field_key_list | string\[\] | 否 | 要删除的自定义字段的 key 列表<br>**示例值**：["account_token_v1"]
