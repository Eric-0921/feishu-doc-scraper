...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/ecological-docking/eco_background_check_package/batch_update
...
id | string | 是 | 账号下已有的套餐 ID<br>**示例值**："pkg001"
...
id | string | 是 | 账号下已有的附加调查项 ID<br>**示例值**："ext001"
