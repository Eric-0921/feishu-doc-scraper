...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/ecological-docking/eco_background_check_custom_field/batch_update
...
custom_field_list | eco_background_check_custom_field_data\[\] | 是 | 自定义字段列表。<br>**注意**：列表长度须与[创建背调自定义字段](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/eco_background_check_custom_field/create)时传入的一致
