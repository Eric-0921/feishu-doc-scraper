...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/ecological-docking/eco_background_check/update_result
...
report_url_type | int | 否 | 报告地址类型；枚举值为空或 1 时为可下载的 pdf 链接，2 为预览型链接<br>**示例值**：1<br>**可选值有**：<br>- 1：可下载的链接<br>- 2：外链型链接
