...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/get-candidates/website/list-3
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | string | 否 | 分页大小<br>**示例值**：100<br>**默认值**：`10`<br>**数据校验规则**：<br>- 最大值：`200`
