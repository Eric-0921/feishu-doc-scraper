...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/get-candidates/referral/list
...
名称 | 类型 | 必填 | 描述
---|---|---|---
process_type | int | 否 | 招聘流程类型<br>**示例值**：1<br>**可选值有**：<br>- 1：社招<br>- 2：校招
...
page_size | int | 否 | 每页获取记录数量<br>**示例值**：10<br>**默认值**：`10`<br>**数据校验规则**：<br>- 最大值：`10`
