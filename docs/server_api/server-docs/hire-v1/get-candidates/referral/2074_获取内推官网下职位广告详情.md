...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/get-candidates/referral/get
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取内推官网信息(hire:referral_website:readonly)
...
名称 | 类型 | 描述
---|---|---
job_post_id | string | 职位广告 ID，可通过[获取内推官网下职位广告列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/referral_website-job_post/list)获取<br>**示例值**："6701528341100366094"
...
experience | int | 工作经验<br>**可选值有**：<br>- 1：不限<br>- 2：应届毕业生<br>- 3：1年以下<br>- 4：1-3年<br>- 5：3-5年<br>- 6：5-7年<br>- 7：7-10年<br>- 8：10年以上
headcount | int | 招聘数量
