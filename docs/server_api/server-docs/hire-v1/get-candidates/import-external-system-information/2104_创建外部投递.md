...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/get-candidates/import-external-system-information/create
...
名称 | 类型 | 必填 | 描述
---|---|---|---
external_id | string | 否 | 外部系统投递主键 （仅用于幂等）<br>- 若不传此值，则不进行幂等校验<br>- 若传此值，则用于幂等校验，同一 `external_id` 24小时内仅可创建一次<br>**示例值**："729557715718"
job_recruitment_type | int | 否 | 职位招聘类型<br>**示例值**：1<br>**可选值有**：<br>- 1：社招<br>- 2：校招
job_title | string | 否 | 职位名称<br>**示例值**："高级 Java"
resume_source | string | 否 | 简历来源<br>**示例值**："内推"
stage | string | 否 | 阶段名称<br>**示例值**："简历初筛"
talent_id | string | 是 | 人才 ID，可通过[获取人才列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/list)接口获取<br>**示例值**："6960663240925956459"
termination_reason | string | 否 | 终止原因<br>**示例值**："不合适"
delivery_type | int | 否 | 投递类型<br>**示例值**：1<br>**可选值有**：<br>- 1：HR 寻访<br>- 2：候选人主动投递<br>- 3：人才推荐<br>- 4：其他
