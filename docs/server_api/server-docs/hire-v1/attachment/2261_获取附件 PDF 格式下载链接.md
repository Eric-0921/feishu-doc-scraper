...
> Source: https://open.feishu.cn/document/server-docs/hire-v1/attachment/preview
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 上传招聘相关附件(hire:attachment)
...
名称 | 类型 | 描述
---|---|---
attachment_id | string | 附件 ID，可通过[获取人才信息](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/get)接口返回数据中获取人才简历附件 ID。<br>**示例值**："64352523512563462"
