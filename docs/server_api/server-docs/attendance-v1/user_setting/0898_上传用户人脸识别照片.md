...
> Source: https://open.feishu.cn/document/server-docs/attendance-v1/user_setting/upload
...
名称 | 类型 | 必填 | 描述
---|---|---|---
file_name | string | 是 | 带后缀的文件名<br>**示例值**：人脸照片.jpg

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
file | file | 否 | 文件内容<br>**示例值**：二进制文件
