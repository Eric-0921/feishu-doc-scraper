...
> Source: https://open.feishu.cn/document/server-docs/attendance-v1/user_daily_shift/query
...
名称 | 类型 | 必填 | 描述
---|---|---|---
user_ids | string\[\] | 是 | employee_no 或 employee_id 列表，与employee_type对应。最多50人。<br>**示例值**：["abd754f7"]
