...
> Source: https://open.feishu.cn/document/server-docs/attendance-v1/user_stats_data/query-2
...
stats_type | string | 是 | 统计类型<br>**示例值**："daily"<br>**可选值有**：<br>- daily：日度统计<br>- month：月度统计
start_date | int | 是 | 开始时间，格式为yyyyMMdd（无效字段）<br>**示例值**：20210316
end_date | int | 是 | 结束时间，格式为yyyyMMdd（时间间隔不超过 40 天）（无效字段）<br>**示例值**：20210323
...
stats_type | string | 统计类型<br>**可选值有**：<br>- daily：日度统计<br>- month：月度统计
