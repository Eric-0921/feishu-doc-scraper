...
> Source: https://open.feishu.cn/document/server-docs/attendance-v1/user_task_remedy/query_user_allowed_remedys
...
remedy_date | int | 是 | 补卡日期，格式为yyyyMMdd<br>**示例值**：20210104
