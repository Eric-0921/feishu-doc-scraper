...
> Source: https://open.feishu.cn/document/cardkit-v1/card-element/delete
...
element_id | string | 指定卡片实体内，要删除的组件 ID。对应卡片 JSON 中的 `element_id` 属性，由开发者自定义。<br>**示例值**："markdown_1"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `20` 字符
