...
> Source: https://open.feishu.cn/document/group/upgraded-group-announcement/chat-announcement-block/get-2
...
block_id | string | Block 的唯一标识。你可通过调用[获取群公告所有块](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/list)接口获取块的 block_id。<br>**示例值**："doxcnO6UW6wAw2qIcYf4hZpFIth"
...
page_size | int | 否 | 分页大小<br>**示例值**：500<br>**默认值**：`500`<br>**数据校验规则**：<br>- 最小值：`1`
