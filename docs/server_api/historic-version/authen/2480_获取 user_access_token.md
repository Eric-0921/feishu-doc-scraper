...
> Source: https://open.feishu.cn/document/historic-version/authen/create-3
...
code | string | 是 | 登录预授权码，调用[登录预授权码](https://open.feishu.cn/document/common-capabilities/sso/api/obtain-oauth-code) 获取code<br>**示例值**："xMSldislSkdK"
