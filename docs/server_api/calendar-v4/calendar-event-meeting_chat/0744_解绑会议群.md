...
> Source: https://open.feishu.cn/document/calendar-v4/calendar-event-meeting_chat/delete
...
名称 | 类型 | 描述
---|---|---
calendar_id | string | 日程所在的日历 ID。<br>**示例值**："feishu.cn_xxx@group.calendar.feishu.cn"
event_id | string | 日程 ID。<br>**示例值**："75d28f9b-e35c-4230-8a83-123_0"

### 查询参数

名称 | 类型 | 必填 | 描述
---|---|---|---
meeting_chat_id | string | 是 | 会议群 ID。在创建会议群时会返回会议群 ID。<br>**示例值**：oc_xxx
