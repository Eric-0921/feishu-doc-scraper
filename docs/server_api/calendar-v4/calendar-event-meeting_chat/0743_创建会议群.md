...
> Source: https://open.feishu.cn/document/calendar-v4/calendar-event-meeting_chat/create
...
msg | string | 错误描述
data | \- | \-
meeting_chat_id | string | 会议群 ID。后续可用于解绑会议群。
