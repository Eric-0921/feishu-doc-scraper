...
> Source: https://open.feishu.cn/document/client-docs/gadget/-web-app-api/open-ability/login/code2session
...
名称 | 类型 | 必填 | 描述
---|---|---|---
Authorization | string | 是 | `app_access_token`<br>**值格式**："Bearer `access_token`"<br>**示例值**："Bearer t-7f1bcd13fc57d46bac21793a18e560"<br>[了解更多：获取与使用access_token](https://open.feishu.cn/document/ukTMukTMukTM/uMTNz4yM1MjLzUzM)
...
&emsp;∟&nbsp;employee_id | string | 用户的[User ID](https://open.feishu.cn/document/home/user-identity-introduction/user-id)，在职员工在企业内的唯一标识 <br>**仅当开通以下权限后 返回该字段**：<br>获取用户 user ID(contact:user.employee_id:readonly)
