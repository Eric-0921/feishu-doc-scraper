...
> Source: https://open.feishu.cn/document/corehr-v1/common_data-id/events/user_mapping_changed
...
支持的应用类型 | Custom App
权限要求<br>**订阅该事件所需的权限，开启其中任意一项权限即可订阅** | 获取 ID 转换信息(corehr:common_data.id.convert:read)
...
func main() {
	...
	eventHandler := dispatcher.NewEventDispatcher("", "").
		OnP2CommonDataIdUserMappingChangedV1(func(ctx context.Context, event *larkcorehr.P2CommonDataIdUserMappingChangedV1) error {
			fmt.Printf("[ OnP2CommonDataIdUserMappingChangedV1 access ], data: %s\n", larkcore.Prettify(event))
			return nil
		})
...
def do_p2_corehr_common_data_id_user_mapping_changed_v1(data: lark.corehr.v1.P2CorehrCommonDataIdUserMappingChangedV1) -> None:
    print(f'[ do_p2_corehr_common_data_id_user_mapping_changed_v1 access ], data: {lark.JSON.marshal(data, indent=4)}')

# 注册事件 Register event
event_handler = lark.EventDispatcherHandler.builder("", "") \
    .register_p2_corehr_common_data_id_user_mapping_changed_v1(do_p2_corehr_common_data_id_user_mapping_changed_v1) \
    .build()
...
import com.lark.oapi.service.corehr.v1.model.P2CommonDataIdUserMappingChangedV1;
...
public class Sample {
    ...
    private static final EventDispatcher EVENT_HANDLER = EventDispatcher.newBuilder("", "")
            .onP2CommonDataIdUserMappingChangedV1(new CorehrService.P2CommonDataIdUserMappingChangedV1Handler() {
                @Override
                public void handle(P2CommonDataIdUserMappingChangedV1 event) throws Exception {
                    System.out.printf("[ onP2CommonDataIdUserMappingChangedV1 access ], data: %s\n", Jsons.DEFAULT.toJson(event.getEvent()));
                }
            })
            .build();
...
wsClient.start({
    ...
    eventDispatcher: new Lark.EventDispatcher({}).register({
        'corehr.common_data.id.user_mapping_changed_v1': async (data) => {
            console.log(data);
        }
    })
});
