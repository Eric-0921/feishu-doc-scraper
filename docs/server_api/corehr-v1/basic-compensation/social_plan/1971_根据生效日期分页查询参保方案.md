...
> Source: https://open.feishu.cn/document/corehr-v1/basic-compensation/social_plan/list
...
insurance_type | string | 否 | 社保方案/公积金方案<br>**示例值**：social_insurance<br>**可选值有**：<br>- social_insurance：社保<br>- provident_fund：公积金<br>**数据校验规则**：<br>- 长度范围：`8` ～ `64` 字符
