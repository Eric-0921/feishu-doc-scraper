...
> Source: https://open.feishu.cn/document/corehr-v1/pre_hire/withdraw_onboarding
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 撤销入职(corehr:pre_hire:withdraw_onboarding)
