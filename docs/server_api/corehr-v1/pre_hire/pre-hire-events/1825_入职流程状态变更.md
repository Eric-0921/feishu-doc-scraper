...
> Source: https://open.feishu.cn/document/corehr-v1/pre_hire/pre-hire-events/onboarding_task_changed
...
after_status | string | 入职流程状态变更<br>**可选值有**：<br>- not_started：未开始<br>- in_progress：进行中<br>- completed：已完成（完成入职）<br>- withdrawn：已撤销（撤销待入职）<br>- others：其他(异常情况)<br>- expired：已失效(回退至Offer沟通阶段)
