...
> Source: https://open.feishu.cn/document/corehr-v1/job-management/job_grade/query
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用**<br>开启任一权限即可 | 获取核心人事信息(corehr:corehr:readonly)<br>查看职等信息(corehr:job_grade:read)<br>查看、创建、更新、删除职等信息(corehr:job_grade:write)<br>更新核心人事信息(corehr:corehr)
