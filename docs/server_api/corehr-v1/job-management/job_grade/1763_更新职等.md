...
> Source: https://open.feishu.cn/document/corehr-v1/job-management/job_grade/patch
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看、创建、更新、删除职等信息(corehr:job_grade:write)
...
名称 | 类型 | 描述
---|---|---
job_grade_id | string | 职等ID。ID获取方式：<br>- 调用[【创建职等】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_grade/create)[【查询租户的职等信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/job_grade/query)等接口可以返回职等ID<br>**示例值**："6862995757234914824"
...
value | string | 是 | 文本内容<br>- 名称不能包含「/」「；」「;」「\」「'」字符<br>**示例值**："中文示例"
