...
> Source: https://open.feishu.cn/document/corehr-v1/employee/cost_allocation/create_version
...
effective_time | string | 是 | 分摊生效日期<br>**示例值**："2024-12-01"
expiration_time | string | 否 | 分摊失效日期<br>**示例值**："2024-12-02"
job_data_cost_center_id | job_data_cost_center\[\] | 否 | 成本分摊<br>**数据校验规则**：<br>- 长度范围：`1` ～ `50`
cost_center_id | string | 是 | 成本中心 ID<br>-可以调用[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口，获取对应成本中心信息的成本中心ID。<br>**示例值**："6950635856373745165"
new_rate | number(float) | 是 | 分摊比例<br>**示例值**：50.2
