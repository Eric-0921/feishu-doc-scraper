...
> Source: https://open.feishu.cn/document/corehr-v1/employee/default_cost_center/create_version
...
effective_time | string | 是 | 生效日期<br>**示例值**："2024-12-01"
cost_center_id | string | 否 | 成本中心ID<br>-可以调用[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口，获取成本中心信息中的成本中心ID。<br>**示例值**："7039123253031711012"
