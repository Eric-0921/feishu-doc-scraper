...
> Source: https://open.feishu.cn/document/corehr-v1/offboarding/resignation-events/checklist_updated
...
基本 | &nbsp;
---|---
事件类型 | corehr.offboarding.checklist_updated_v2
支持的应用类型 | Custom App、Store App
权限要求<br>**订阅该事件所需的权限，开启其中任意一项权限即可订阅**<br>开启任一权限即可 | 订阅离职流转状态变更事件(corehr:offboarding.checklist_status_message:read)<br>获取员工离职信息(corehr:offboarding:read)<br>更新雇佣信息(corehr:employment)<br>获取雇佣信息(corehr:employment:readonly)<br>读写员工离职信息(corehr:offboarding:write)
...
target_user_id | user_id | 离职员工的用户ID
...
checklist_process_id | string | 离职流转流程的实例 ID，可用于[查询流程相关信息](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)，例如：作为[获取单个流程详情](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/list)的process_id查询流程详情。
checklist_status | int | 离职流转状态<br>**可选值有**：<br>- 1：未发起<br>- 2：进行中<br>- 3：已完成<br>- 4：已拒绝<br>- 5：已撤销
