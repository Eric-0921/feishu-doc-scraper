...
> Source: https://open.feishu.cn/document/corehr-v1/authorization/list-2
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看 BP 列表(corehr:bp.list:read)
...
名称 | 类型 | 必填 | 描述
---|---|---|---
page_size | int | 是 | 分页大小，最大 500<br>**示例值**：500<br>**数据校验规则**：<br>- 取值范围：`1` ～ `500`
...
hrbp_id | string | 部门 HRBP 的雇佣 ID，不包括上级部门的 HRBP<br>> <br>如想获取员工详细信息，可通过[搜索员工信息](https://open.larkoffice.com/document/server-docs/corehr-v1/employee/search)接口获取。
