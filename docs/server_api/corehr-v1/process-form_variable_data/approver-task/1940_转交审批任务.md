...
> Source: https://open.feishu.cn/document/corehr-v1/process-form_variable_data/approver-task/update-2
...
to_user_id | string | 是 | 被转交人，按user_id_type类型传递<br>**示例值**："7184703091806602796"
approver_ids | string\[\] | 是 | 待转交审批任务id列表<br>同一个审批节点如果有多个审批人，不同审批人的 approver_id 不同。<br>可通过 [获取单个流程详情](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/process/get)接口获取流程中各审批任务的 approver_id。<br>**示例值**：["7424452160928106028"]<br>**数据校验规则**：<br>- 长度范围：`1` ～ `20`
remark | string | 否 | 备注<br>**示例值**："备注"
system_user | boolean | 否 | 是否以系统身份操作，如果为fasle，则operator必填<br>**示例值**：true<br>**默认值**：`false`
