...
> Source: https://open.feishu.cn/document/corehr-v1/process-form_variable_data/process-instance/resource-introduction
...
status | int | 流程状态<br>**可选值有：**<br>- `1`：进行中<br>- `2`：拒绝<br>- `4`：撤回<br>- `8`：撤销<br>- `9`：已完成
...
node_definition_id | string | 节点定义ID（注：在回退场景，同一个节点会对应多个节点实例）
properties | int | 普通流程或撤销流程等<br>**可选值有：**<br>- `1`：普通流程<br>- `2`：撤销流程
