...
> Source: https://open.feishu.cn/document/corehr-v1/basic-infomation/enum/search
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 获取元数据信息(corehr:common_data.meta_data:read)
