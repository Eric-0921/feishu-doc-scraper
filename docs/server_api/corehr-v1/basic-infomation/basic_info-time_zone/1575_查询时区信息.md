...
> Source: https://open.feishu.cn/document/corehr-v1/basic-infomation/basic_info-time_zone/search
...
名称 | 类型 | 必填 | 描述
---|---|---|---
time_zone_id_list | string\[\] | 否 | 时区 ID 列表，如果为空，返回所有数据<br>**示例值**：["6862995813451171342"]<br>**数据校验规则**：<br>- 长度范围：`0` ～ `100`
status_list | int\[\] | 否 | 状态列表<br>**示例值**：[1]<br>**可选值有**：<br>- 1：生效<br>- 0：失效<br>**默认值**：`[1]`<br>**数据校验规则**：<br>- 长度范围：`0` ～ `2`
