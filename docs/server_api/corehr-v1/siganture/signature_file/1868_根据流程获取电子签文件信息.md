...
> Source: https://open.feishu.cn/document/corehr-v1/siganture/signature_file/list_by_biz_id
...
名称 | 类型 | 必填 | 描述
---|---|---|---
biz_process_id | string | 是 | 业务自定义流程ID，唯一不重复，不要超过100字符<br>**示例值**：129b83f5-c023-4e85-b2c7-80ce777e57fd
biz_type | string | 是 | 业务类型，开放平台发起的流程传OpenAPI，BPM发起的流程传入Bpm，目前只支持这两种业务类型<br>**示例值**：OpenAPI、Bpm
...
select_sign_url | boolean | 否 | 是否需要返回签署链接<br>**示例值**：true
