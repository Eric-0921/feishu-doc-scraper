...
> Source: https://open.feishu.cn/document/corehr-v1/organization-management/department/events/updated-2
...
field_changes | string\[\] | 发生变更的字段<br>**数据校验规则**：<br>- 长度范围：`0` ～ `1000`
