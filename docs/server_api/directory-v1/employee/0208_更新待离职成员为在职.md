...
> Source: https://open.feishu.cn/document/directory-v1/employee/regular
...
名称 | 类型 | 描述
---|---|---
employee_id | string | 员工ID，与employee_id_type类型保持一致<br>**示例值**："d2e1jas"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `255` 字符
