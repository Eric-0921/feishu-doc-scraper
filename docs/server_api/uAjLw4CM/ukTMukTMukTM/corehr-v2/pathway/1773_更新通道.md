...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/pathway/patch
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 读写通道信息(corehr:pathway:write)
...
value | string | 是 | - 文本内容，最长支持255个字符<br>- 名称不能包含「/」「；」「;」「\」「'」字符<br>**示例值**："中文示例"
