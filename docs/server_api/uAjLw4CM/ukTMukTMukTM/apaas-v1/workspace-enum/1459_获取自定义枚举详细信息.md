...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-enum/enum_get
...
基本 | &nbsp;
---|---
HTTP URL | https://open.feishu.cn/open-apis/apaas/v1/workspaces/:workspace_id/enums/:enum_name
HTTP Method | GET
...
enum_name | string | 枚举名称<br>**示例值**："enum_demo_1"
