...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/apaas-v1/workspace-table/records_patch
...
名称 | 类型 | 必填 | 描述
---|---|---|---
filter | string | 是 | 筛选条件，尊许 PostgREST 语法，详情可查看 `https://docs.postgrest.org/en/v13/references/api/tables_views.html#horizontal-filtering`<br>此处用法和查询数据记录一致。<br>- 示例：查找 student 表中 age 大于 10 的学生列表：age=gt.10, URLEncode 后拼在 filter 中。<br>**示例值**：age%3Dgt.10

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
record | string | 是 | 要更新的数据记录信息<br>**示例值**："{\"age\":10}"
