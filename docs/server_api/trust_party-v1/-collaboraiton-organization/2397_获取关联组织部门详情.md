...
> Source: https://open.feishu.cn/document/trust_party-v1/-collaboraiton-organization/get-2
...
target_department_id | string | 对方关联组织的部门，需要与target_department_id_type中填写的值保持一致<br>**示例值**："od-4e6ac4d14bcd5071a37a39de902c7141"

### 查询参数

名称 | 类型 | 必填 | 描述
---|---|---|---
target_department_id_type | string | 否 | 对方关联组织的入参部门类型<br>**示例值**：department_id<br>**可选值有**：<br>- department_id：部门ID<br>- open_department_id：部门open ID<br>**默认值**：`department_id`
...
leader_type | int | 负责人类型<br>**可选值有**：<br>- 1：主负责人<br>- 2：副负责人
