...
> Source: https://open.feishu.cn/document/trust_party-v1/searchable-and-visible-rules/delete
...
名称 | 类型 | 描述
---|---|---
collaboration_rule_id | string | 规则ID，可通过[查询可搜可见规则](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/directory-v1/collaboration_rule/list)获得<br>**示例值**："2121"
