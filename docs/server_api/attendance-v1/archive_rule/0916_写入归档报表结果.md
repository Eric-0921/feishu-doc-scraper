...
> Source: https://open.feishu.cn/document/attendance-v1/archive_rule/upload_report
...
code | string | 是 | 字段编码，可根据[查询归档报表表头](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/attendance-v1/archive_rule/user_stats_fields_query) 获取<br>**示例值**："abd754f7"
