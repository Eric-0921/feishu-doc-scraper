...
> Source: https://open.feishu.cn/document/security_and_compliance-v1/openapi_log/list_data
...
支持的应用类型 | Custom App
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 查看 OpenAPI 审计日志(security_and_compliance:audit_log.openapi_log:readonly)
