...
> Source: https://open.feishu.cn/document/security_and_compliance-v1/security_and_compliance-v2/device_apply_record/update
...
权限要求<br>**调用该 API 所需的权限。开启其中任意一项权限即可调用** | 审核自主申报申请(security_and_compliance:device_apply_record:write)
...
名称 | 类型 | 描述
---|---|---
device_apply_record_id | string | 设备申报记录ID<br>**示例值**："7088763625288187923"

### 请求体

名称 | 类型 | 必填 | 描述
---|---|---|---
is_approved | boolean | 是 | 是否审批通过<br>**示例值**：true
