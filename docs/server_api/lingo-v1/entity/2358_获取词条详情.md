...
> Source: https://open.feishu.cn/document/lingo-v1/entity/get
...
名称 | 类型 | 描述
---|---|---
entity_id | string | 词条 ID<br>**示例值**："enterprise_515879"

### 查询参数

名称 | 类型 | 必填 | 描述
---|---|---|---
provider | string | 否 | 外部系统<br>**示例值**：星云<br>**数据校验规则**：<br>- 长度范围：`2` ～ `32` 字符
outer_id | string | 否 | 词条在外部系统中对应的唯一 ID<br>**示例值**：123aaa<br>**数据校验规则**：<br>- 长度范围：`1` ～ `64` 字符
