...
> Source: https://open.feishu.cn/document/lingo-v1/entity/match
...
名称 | 类型 | 必填 | 描述
---|---|---|---
word | string | 是 | 搜索关键词，将与词条名、别名进行精准匹配<br>**示例值**："飞书词典"<br>**数据校验规则**：<br>- 长度范围：`1` ～ `100` 字符
...
type | int | 匹配中的字段<br>**可选值有**：<br>- 0：词条名<br>- 1：全称<br>- 2：别名
