...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/capability-components/passport-capability/harmony-passport-capability

---

# alchemy_passport_api - Harmony Passport能力 - 能力组件

| 组件名称 | 组件类型 | 组件版本 |  生效基线 |
| --- | --- | --- | --- |
| alchemy_passport_api | 能力组件 | 1.0.1 | 7.32.0 |
