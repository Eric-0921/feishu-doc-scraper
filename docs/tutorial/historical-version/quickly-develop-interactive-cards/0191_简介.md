...
---|---|---
[发送消息](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/create)  <br>`POST`  /open.feishu.cn/open-apis/im/v1/messages | 以应用的身份发消息(im:message:send_as_bot)<br>获取与发送单聊、群组消息(im:message)<br>发送消息V2(im:message:send) | `tenant_access_token`
[延时更新消息卡片](https://open.feishu.cn/document/ukTMukTMukTM/uMDO1YjLzgTN24yM4UjN)  <br>`POST`  /open-apis/interactive/v1/card/update | / | `tenant_access_token`
