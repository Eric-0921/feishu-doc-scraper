...
update_multi | Boolean | 是否为共享卡片，取值：<br>* **true**：共享卡片，更新卡片的内容对所有收到这张卡片的人员可见。<br>* **false**：独享卡片，即仅操作用户可见卡片的更新内容。<br>默认为 **false**。<br>**注意事项**：更多介绍请参考 [交互模块](https://open.feishu.cn/document/ukTMukTMukTM/uYjNwUjL2YDM14iN2ATN) 。
