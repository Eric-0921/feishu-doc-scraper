...
## 操作步骤
1. 执行以下命令，下载[示例代码](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/8841fb595ea110a900ef092f52e80fd0_VFYrhlOpLw.zip)到本地。
   * Mac OS 或 Linux执行以下命令。
      ```Shell
      curl https://sf3-cn.feishucdn.com/obj/open-platform-opendoc/8841fb595ea110a900ef092f52e80fd0_VFYrhlOpLw.zip -o web_app_with_auth.zip
