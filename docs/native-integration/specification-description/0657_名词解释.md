...
> Source: https://open.feishu.cn/document/native-integration/specification-description/glossary
...
原生集成控制台 | 飞书提供的管理端，目前由飞书交付平台承接。主要使用场景如下：<br>1. 飞书研发用于管理组件开发需要的基线、开放能力等；<br>1. 飞书测试用于管控外部组件交付质量；<br>1. 三方厂商/客户用于管理自研组件、待交付项目
