...
> Source: https://open.feishu.cn/document/common-capabilities/web-components/uYDO3YjL2gzN24iN3cjN/feature-config
...
| 是否收起目录 只在初始化设置有效 | boolean | extensions.directory.pin     | ✅  | ❌      |
