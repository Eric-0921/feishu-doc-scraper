...
名称 | 数据类型 | 必填 | 默认值 | 描述
---|---|---|---|---
lk_unique | boolean | 否 | false | **true**：指定打开飞书客户端，而不打开品牌定制客户端与私有化客户端。<br>**false**：可打开飞书 / 品牌定制客户端 / 私有化客户端；如果用户安装了多个客户端，则随机打开其中一个。<br>**注意事项**：飞书 V5.12.0 及以上版本支持。如果设为true，低版本飞书客户端将无法唤起。
brand_t | String | 否 | &nbsp; | 取值为飞书租户域名前缀，可以打开文档首页查看域名前缀。如文档首页地址为 [https://g4u31ee3yc.feishu.cn/drive/home/](https://g4u31ee3yc.feishu.cn/drive/home/)，Applink 链接应该为 [https://applink.feishu.cn/?brand_t=g4u31ee3yc](https://applink.feishu.cn/?brand_t=g4u31ee3yc)<br>**注意事项**：saas定制版飞书客户端使用，标准版飞书用户无需关注。
