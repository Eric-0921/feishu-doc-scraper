...
强制更新 | 当用户冷启动应用时，系统会强制更新为新版小程序。该更新方式可能导致首次打开应用的时间变长，你需要确认当前版本为稳定版本后，再使用该更新方式。<br>**注意事项**：强制更新仅针对飞书客户端 v5.12 及以上版本生效。 | - 场景一：修复线上问题，需尽快使用户升级到新版本。<br>- 场景二：不兼容更新。服务端代码与老版本客户端代码不兼容，要求所有用户都升级到新版本。
