...
**说明**：所有飞书版本均可查看 API 调用次数的已用量，其中，飞书基础免费版的 API 调用次数总量显示为 **10,000**。
...
你可以联系企业管理员升级飞书版本。飞书版本介绍与升级入口，参见[版本对比](https://www.feishu.cn/service)，如有疑问可[联系客服](https://applink.feishu.cn/client/web_url/open?width=400&height=600&mode=window&url=https%3A%2F%2Fwww.feishu.cn%2Focic%3Fsource%3D1%26channel_id%3D36)。
