...
集成工具操作 | Android 原理解释
---|---
关联模块 | 选择工程子模块、新建本地工程子模块，并依赖对应的协议组件、能力组件。依赖关系会落盘在上文提到的 integration_config.json 文件。<br>协议组件在子工程需要有开发者对飞书 Api 协议的实现，能力组件关联之后，可调用飞书相关的能力选择工程子模块、新建本地工程子模块，并依赖对应的协议组件、能力组件。依赖关系会落盘在上文提到的 integration_config.json 文件。<br>协议组件在子工程需要有开发者对飞书 Api 协议的实现，能力组件关联之后，可调用飞书相关的能力
