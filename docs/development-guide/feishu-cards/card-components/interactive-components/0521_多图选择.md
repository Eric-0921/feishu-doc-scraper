...
style | 否 | String | default | 图片加载等状态时的组件风格样式。可取值：<br>- default：默认灰色样式<br>- laser：彩色渐变样式，建议 AI 场景使用![示例图](http:////sf3-cn.feishucdn.com/obj/open-platform-opendoc/0ae7b865c1aa37f29d8647f0ea329b38_usdAFosDoT.png?height=163&lazyload=true&width=433)
