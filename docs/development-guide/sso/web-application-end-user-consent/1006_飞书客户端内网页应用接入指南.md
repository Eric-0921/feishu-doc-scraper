...
> Source: https://open.feishu.cn/document/sso/web-application-end-user-consent/webapp-incremental-authorization-access-guide
...
## 整体流程
![webapp_incremental_auth_cn](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/0a4ed785458045b9ba64ed4b8a29949e_7eMyZO0adx.jpeg?height=2226&lazyload=true&width=2560)

## 操作步骤
### 第一步：配置重定向地址
在开发者后台创建应用或选择已有应用，进入应用详情页 > 开发配置 > 安全设置模块，配置重定向 URL。请确保调用端内网页应用授权接口的页面地址已添加在重定向 URL 的列表中。

![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/1dc62df21b034736fa83dfb82fcc710f_sC3j6n3waM.png?height=687&lazyload=true&maxWidth=600&width=1756)
...
![](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/6ed3d748ee4258f066a55fd29c34534e_nl4iHYIYpd.png?height=873&lazyload=true&maxWidth=600&width=1886)
...
![auth_sheet_cn](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/084015004ad984b07edfb258ce72b4da_90NpliBuUy.png?height=902&lazyload=true&maxWidth=500&width=600)
