...
效果 | 描述 | 示例
---|---|---
**位移** | 描述元素在页面中的位置变化，通过位移在 XYZ 轴上不同的变化方向，可以达到向用户提示页面层级关系的目的。 | ![位移.gif](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/fcc1a069b354ab6254bacae6b4ac534b_He3tI26wbw.gif?height=1200&lazyload=true&width=1600)
**缩放** | 描述元素在页面中的比例变化，通常用于强调页面元素的目的，也可以用于在平面空间中模拟元素在 Z 轴上的位移。 | ![缩放.gif](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/82fd8d36d93e94faf459614f4b4bf454_E9F50v8zBI.gif?height=1200&lazyload=true&width=1600)
**旋转** | 描述元素在页面中的角度变化， 通常用于暗示元素变化的方向趋势。 | ![旋转.gif](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/a7e1d74898f4622a0415f470422aae27_99Kb4D37Qa.gif?height=1200&lazyload=true&width=1600)
**透明度** | 描述元素在页面中的透明度变化，通常用于元素出现和消失的场景 。 | ![透明度.gif](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/a6c567918e96ead0b7a58498b9aff5d5_gblAHayi9w.gif?height=1200&lazyload=true&width=1600)
**颜色** | 描述元素在页面中的颜色变化，通常用于表达元素在选中时的强调，一些特殊颜色的变化也可以表达元素的状态发生改变。 | ![颜色.gif](//sf3-cn.feishucdn.com/obj/open-platform-opendoc/81651df74d6ab693860ec83acb322553_uELOxOcdj3.gif?height=1200&lazyload=true&width=1600)
