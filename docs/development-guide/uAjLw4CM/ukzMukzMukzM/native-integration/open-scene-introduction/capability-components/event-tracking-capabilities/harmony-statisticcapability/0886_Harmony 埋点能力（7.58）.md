...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/capability-components/event-tracking-capabilities/harmony-statisticcapability/harmony-statistic-capability-758
...
| 组件名称 | 组件类型 | 组件版本 | 生效基线 |
| --- | --- | --- | --- |
| alchemy_statistics_api | 能力组件 | 1.0.0 | 7.58.0 |
