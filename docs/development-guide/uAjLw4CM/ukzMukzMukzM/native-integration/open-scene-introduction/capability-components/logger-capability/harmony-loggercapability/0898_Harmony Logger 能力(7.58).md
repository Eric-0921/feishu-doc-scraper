# Harmony Logger 能力(7.58)

> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/capability-components/logger-capability/harmony-loggercapability/harmony-logger-capability758

---

# Harmony Logger能力(7.58)

| 组件名称 | 组件类型 | 组件版本 | 生效基线 |
| --- | --- | --- | --- |
| alchemy_logger_api | 能力组件 | 1.0.0 | 7.58.0 |
