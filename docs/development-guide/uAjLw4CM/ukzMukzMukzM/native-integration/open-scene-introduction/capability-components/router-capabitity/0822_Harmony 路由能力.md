...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/capability-components/router-capabitity/harmony-router-capability

---

# alchemy_nativerouter_api - Harmony 原生路由管理 - 能力组件

| 组件名称 | 组件类型 | 组件版本 |  生效基线 |
| --- | --- | --- | --- |
| alchemy_nativerouter_api | 能力组件 | 1.0.0 | 7.32.0 |
