...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/capability-components/storage-kv-capability/harmony-storage-kv-capability/alchemy_kvstorage_api-758
...
| 组件名称 | 组件类型 | 组件版本 | 生效基线 |
| --- | --- | --- | --- |
| alchemy_kvstorage_api | 能力组件 | 1.0.0 | 7.58.0 |
