...
> Source: https://open.feishu.cn/document/uAjLw4CM/ukzMukzMukzM/native-integration/open-scene-introduction/protocol-components/life-cycle/harmony-life-cycle/harmony-life-cycle-758
...
| 组件名称 | 组件类型 | 组件版本 | 生效基线 |
| --- | --- | --- | --- |
| alchemy_lifecycle_api | 协议组件 | 1.0.0 | 7.58.0 |
...
interface IAlchemyLifeCycle {
  onCreate(context: Context): void // MainAbility 创建后触发
